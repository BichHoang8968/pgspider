...
/* orig_tokens */
 ...
 %nonassoc IDENT
%nonassoc CSTRING
%nonassoc UIDENT GENERATED NULL_P PARTITION RANGE ROWS PRECEDING FOLLOWING CUBE ROLLUP
 %left Op OPERATOR
 %left '+' '-'
 %left '*' '/' '%'
 %left '^'
...
|  CREATE FOREIGN TABLE qualified_name PARTITION OF qualified_name OptTypedTableElementList ForValues SERVER name create_generic_options
 { 
 $$ = cat_str(9,mm_strdup("create foreign table"),$4,mm_strdup("partition of"),$7,$8,$9,mm_strdup("server"),$11,$12);
}
|  CREATE FOREIGN TABLE IF_P NOT EXISTS qualified_name PARTITION OF qualified_name OptTypedTableElementList ForValues SERVER name create_generic_options
 { 
...
;
 ...
 { 
 $$ = cat_str(14,mm_strdup("create trigger"),$3,$4,$5,mm_strdup("on"),$7,$8,$9,$10,mm_strdup("execute procedure"),$13,mm_strdup("("),$15,mm_strdup(")"));
}
