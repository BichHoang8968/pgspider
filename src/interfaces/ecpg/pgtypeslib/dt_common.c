...
/*	text, token, lexval */
	...
	{
		"fjst", DTZ, -46800
	},							/* Fiji Summer Time (13 hour offset!) */
	{
		"fjt", TZ, -43200
	},							/* Fiji Time */
	{
	...
	{
		"lint", TZ, 50400
	},							/* Line Islands Time (Kiribati; +14 hours!) */
	{
		"lkt", TZ, 21600
	},							/* Lanka Time */
	{
