...
#ifdef PGSPIDER
PG_KEYWORD("datasource", DATASOURCE, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
...
#ifdef PGSPIDER
PG_KEYWORD("migrate", MIGRATE, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
...
#ifdef PGSPIDER
PG_KEYWORD("multi", MULTI, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
...
#ifdef PGSPIDER
PG_KEYWORD("tenant", TENANT, UNRESERVED_KEYWORD, BARE_LABEL)
#endif
