...
/* A list of hash table names PostgreSQL(including contrib module) uses, but hash table names FDWs use are excluded.
   ...
   Generated by contrib/pgspider_core_fdw/tools/extract_hashname.sh
   */
static const char tabname_array[][HASH_TABLE_NAME_LEN] = {
	...
	"smgr relation table",
	"tqueue receiver record type hashtable",
	"tqueue sender record type hashtable",
	"unlogged hash",
	""							/* empty string for end of array */
};

/* normalized id of the current thread */
