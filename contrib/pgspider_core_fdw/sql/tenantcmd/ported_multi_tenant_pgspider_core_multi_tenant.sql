...
--Testcase 66:
CREATE MULTI TENANT pgspider_core_svr;
--Testcase 67:
CREATE USER MAPPING FOR CURRENT_USER MULTI TENANT pgspider_core_svr;
--Testcase 68:
CREATE MULTI TENANT TABLE test1 (i int,__spd_url text) MULTI TENANT pgspider_core_svr;
--Testcase 69:
CREATE MULTI TENANT TABLE test2 (t text, t2 text, i int,__spd_url text) MULTI TENANT pgspider_core_svr;
--- PGSpider 1
--Testcase 70:
...
-- Clean up
--Testcase 122:
DROP USER MAPPING FOR CURRENT_USER MULTI TENANT pgspider_core_svr;
--Testcase 123:
...
--Testcase 129:
DROP MULTI TENANT pgspider_core_svr;
--Testcase 130:
