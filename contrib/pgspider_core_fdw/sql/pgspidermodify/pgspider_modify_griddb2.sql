...
CREATE FOREIGN TABLE tntbl2__griddb_svr__1 (_id text OPTIONS (rowkey 'true'), c1 int, c2 text, c3 boolean, c4 double precision, c5 bigint) SERVER griddb_svr OPTIONS (table_name 'tntbl21');

-- Reset data of remote table before test
DELETE FROM tntbl2__griddb_svr__0;
DELETE FROM tntbl2__griddb_svr__1;
