...
--Testcase 119:
ALTER FOREIGN TABLE tntbl1__sqlite_svr__0 OPTIONS (ADD batch_size '6');
--Testcase 120:
INSERT INTO tntbl1
...
DELETE FROM tntbl1;
--Testcase 122:
ALTER SERVER sqlite_svr OPTIONS (SET batch_size '10');
--Testcase 123:
-- ALTER SERVER pgspider_svr OPTIONS (DROP batch_size);
--Testcase 124:
ALTER FOREIGN TABLE tntbl1__sqlite_svr__0 OPTIONS (DROP batch_size);
--Testcase 125:
INSERT INTO tntbl1
