...
CREATE SERVER sqlite_svr1 FOREIGN DATA WRAPPER sqlite_fdw OPTIONS (database '/tmp/pgmodifytest1.db');
...
-- Foreign tables
--Testcase 11:
CREATE FOREIGN TABLE tntbl1__sqlite_svr__0 (c1 int OPTIONS (key 'true'), c2 smallint, c3 float, c4 double precision, c5 bigint, c6 timestamp, c7 timestamp with time zone, c8 char(30), c9 varchar(50)) SERVER sqlite_svr OPTIONS (table 'tntbl1');
CREATE FOREIGN TABLE tntbl1__sqlite_svr1__0 (c1 int OPTIONS (key 'true'), c2 smallint, c3 float, c4 double precision, c5 bigint, c6 timestamp, c7 timestamp with time zone, c8 char(30), c9 varchar(50)) SERVER sqlite_svr1 OPTIONS (table 'tntbl1');

-- Reset data of remote table before test
DELETE FROM tntbl1__sqlite_svr__0;
DELETE FROM tntbl1__sqlite_svr1__0;
...
INSERT INTO tntbl1__sqlite_svr1__0 VALUES (1000, 0, 1.0, 100.0, 1000, '2022-06-22 14:00:00', '2022-06-22 14:00:00+07', 'sqlite char array', 'sqlite varchar array');

-- SELECT FROM table if there is any record
--Testcase 12:
SELECT * FROM tntbl1 ORDER BY c1, __spd_url;
...
--
--Testcase 28:
INSERT INTO tntbl1 IN ('/sqlite_svr/') VALUES (-10, 20, 82.21, 213.12, 9565, '2003-10-19 10:23:54', '1971-01-01 00:00:01+07', 'One', 'OneOne');
...
--
--Testcase 39:
INSERT INTO tntbl1 (SELECT c1+25, c2+50, c3 FROM tntbl1 ORDER BY 1, 2, 3);
--Testcase 40:
SELECT c1, c2, c3, c4, c5, c6, c7, c8, c9 FROM tntbl1 ORDER BY 1, 2, 3;
...
--
--Testcase 61:
UPDATE tntbl1 IN ('/sqlite_svr/', '/sqlite_svr/') SET c3 = 22.2;
--
-- DELETE
--
...
--
--Testcase 67:
DELETE FROM tntbl1 IN ('/sqlite_svr/') WHERE c1 = 20;
...
--
--
-- ON CONFLICT, this work only on sqlite_fdw
--
--Testcase 88:
...
--
-- WITH CHECK, this work only on sqlite_fdw
--
--Testcase 92:
...
ALTER SERVER sqlite_svr1 OPTIONS (ADD batch_size '10');
...
--Testcase 119:
SELECT * FROM tntbl1__sqlite_svr__0 ORDER BY 1,2;
--Testcase 120:
SELECT * FROM tntbl1__sqlite_svr1__0 ORDER BY 1,2;
