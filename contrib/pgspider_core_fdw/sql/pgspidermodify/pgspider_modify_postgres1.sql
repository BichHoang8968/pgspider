...
-- Foreign tables
--Testcase 11:
CREATE FOREIGN TABLE tntbl1__postgres_svr__0 (c1 int, c2 smallint, c3 float, c4 double precision, c5 bigint, c6 timestamp, c7 timestamp with time zone, c8 char(30), c9 varchar(50)) SERVER postgres_svr OPTIONS (table_name 'tntbl1');

-- Reset data of remote table before test
DELETE FROM tntbl1__postgres_svr__0;
...
--Testcase 117:
ALTER SERVER postgres_svr OPTIONS (ADD batch_size '2');
--Testcase 118:
-- ALTER SERVER pgspider_svr OPTIONS (ADD batch_size '5');
--Testcase 119:
ALTER FOREIGN TABLE tntbl1__postgres_svr__0 OPTIONS (ADD batch_size '6');
--Testcase 120:
INSERT INTO tntbl1
...
DELETE FROM tntbl1;
--Testcase 122:
ALTER SERVER postgres_svr OPTIONS (SET batch_size '10');
--Testcase 123:
-- ALTER SERVER pgspider_svr OPTIONS (DROP batch_size);
--Testcase 124:
ALTER FOREIGN TABLE tntbl1__postgres_svr__0 OPTIONS (DROP batch_size);
--Testcase 125:
INSERT INTO tntbl1
