...
--Testcase 8:
CREATE SERVER pgspider_svr FOREIGN DATA WRAPPER pgspider_fdw OPTIONS (host :PGSPIDER_SERVER1, port :PGSPIDER_PORT1, dbname :PGSPIDER_DB1);
--Testcase 9:
...
-- tntbl1
--Testcase 10:
CREATE FOREIGN TABLE tntbl1 (c1 int, c2 smallint, c3 float, c4 double precision, c5 bigint, c6 timestamp, c7 timestamp with time zone, c8 char(30), c9 varchar(50), __spd_url text) SERVER pgspider_core_svr;

-- Foreign tables
--Testcase 11:
CREATE FOREIGN TABLE tntbl1__pgspider_svr__0 (c1 int, c2 smallint, c3 float, c4 double precision, c5 bigint, c6 timestamp, c7 timestamp with time zone, c8 char(30), c9 varchar(50), __spd_url text) SERVER pgspider_svr OPTIONS (table_name 'tntbl1');
...
--
--Testcase 61:
UPDATE tntbl1 IN ('/pgspider_svr/', '/sqlite_svr/') SET c3 = 22.2;

--
-- INSERT with IN feature
--
--Testcase 28:
INSERT INTO tntbl1 IN ('/pgspider_svr/') VALUES (-10, 20, 82.21, 213.12, 9565, '2003-10-19 10:23:54', '1971-01-01 00:00:01+07', 'One', 'OneOne');
...
--
--Testcase 67:
DELETE FROM tntbl1 IN ('/pgspider_svr/') WHERE c1 = 20;
...
--
-- Check behavior of disable_transaction_feature_check=true
--
