...
-- Foreign tables
--Testcase 11:
CREATE FOREIGN TABLE tntbl1__mysql_svr__0 (c1 int, c2 smallint, c3 float, c4 double precision, c5 bigint, c6 timestamp, c7 timestamp with time zone, c8 char(30), c9 varchar(50)) SERVER mysql_svr OPTIONS (dbname :MYSQL_DB_NAME1, table_name 'tntbl1');

-- Reset data of remote table before test
DELETE FROM tntbl1__mysql_svr__0;
...
SELECT c1, c2, c3, c4, c5, c6, c7, c8, c9 FROM tntbl1 ORDER BY 1, 2, 3;
--Testcase 34:
UPDATE tntbl1 t SET c2 = t.c1 + 10 WHERE t.c3 = 3.0;
--Testcase 35:
SELECT c1, c2, c3, c4, c5, c6, c7, c8, c9 FROM tntbl1 ORDER BY 1, 2, 3;
