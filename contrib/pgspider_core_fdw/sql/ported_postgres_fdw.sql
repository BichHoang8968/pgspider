...
--  Limit
--    Output: t1.*, c3, c1
--    ->  Foreign Scan on public.ft1__postgres_srv__0 t1
--          Output: t1.*, c3, c1
...
-- with WHERE clause
EXPLAIN (VERBOSE, COSTS OFF) SELECT * FROM ft1 t1 WHERE t1.c1 = 101 AND t1.c6 = 'postgres' AND t1.c7 >= 'postgres';
SELECT * FROM ft1 t1 WHERE t1.c1 = 101 AND t1.c6 = 'postgres' AND t1.c7 >= 'postgres';
...
--    ->  Foreign Scan on public.ft2__postgres_srv__0 a
...
--    ->  Foreign Scan on public.ft2__postgres_srv__0 b
--          Output: b.c1, b.c2, b.c3, b.c4, b.c5, b.c6, b.c7, b.c8
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c1, t1.c3
--          Relations: (public.ft1__postgres_srv__0 t1) INNER JOIN (public.ft2__postgres_srv__0 t2)
...
--          ->  Foreign Scan
--                Output: t1.c1, t2.c2, t3.c3, t1.c3
--                Relations: ((public.ft1__postgres_srv__0 t1) INNER JOIN (public.ft2__postgres_srv__0 t2)) INNER JOIN (public.ft4__postgres_srv__0 t3)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c1
--          Relations: (public.ft4__postgres_srv__0 t1) LEFT JOIN (public.ft5__postgres_srv__0 t2)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c2, t3.c3
--          Relations: ((public.ft2__postgres_srv__0 t1) LEFT JOIN (public.ft2__postgres_srv__0 t2)) LEFT JOIN (public.ft4__postgres_srv__0 t3)
...
-- -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--  Foreign Scan
--    Output: t1.c1, t1.c2, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2
--    Relations: (public.ft4__postgres_srv__0 t1) LEFT JOIN (public.ft5__postgres_srv__0)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c1
--          Relations: (public.ft4__postgres_srv__0 t2) LEFT JOIN (public.ft5__postgres_srv__0 t1)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c2, t3.c3
--          Relations: ((public.ft4__postgres_srv__0 t3) LEFT JOIN (public.ft2__postgres_srv__0 t2)) LEFT JOIN (public.ft2__postgres_srv__0 t1)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c1
--          Relations: (public.ft4__postgres_srv__0 t1) FULL JOIN (public.ft5__postgres_srv__0 t2)
...
-- -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--  Foreign Scan
--    Output: ft4__postgres_srv__0.c1, ft5__postgres_srv__0.c1
--    Relations: (public.ft4__postgres_srv__0) FULL JOIN (public.ft5__postgres_srv__0)
...
-- ------------------------------------------------------------------------------------------------------
--  Foreign Scan
--    Output: ft4__postgres_srv__0.c1, t2.c1, t3.c1
--    Relations: (public.ft4__postgres_srv__0) FULL JOIN ((public.ft4__postgres_srv__0 t2) LEFT JOIN (public.ft5__postgres_srv__0 t3))
...
-- ------------------------------------------------------------------------------------------------------
--  Foreign Scan
--    Output: ft4__postgres_srv__0.c1, ft4__postgres_srv__0_1.c1, ft5__postgres_srv__0.c1
--    Relations: (public.ft4__postgres_srv__0) FULL JOIN ((public.ft4__postgres_srv__0) FULL JOIN (public.ft5__postgres_srv__0))
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c1, t3.c1
--          Relations: ((public.ft4__postgres_srv__0 t1) INNER JOIN (public.ft5__postgres_srv__0 t2)) FULL JOIN (public.ft4__postgres_srv__0 t3)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c2, t3.c3
--          Relations: ((public.ft2__postgres_srv__0 t1) FULL JOIN (public.ft2__postgres_srv__0 t2)) FULL JOIN (public.ft4__postgres_srv__0 t3)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c2, t3.c3
--          Relations: ((public.ft2__postgres_srv__0 t2) LEFT JOIN (public.ft2__postgres_srv__0 t1)) FULL JOIN (public.ft4__postgres_srv__0 t3)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c2, t3.c3
--          Relations: ((public.ft2__postgres_srv__0 t1) FULL JOIN (public.ft2__postgres_srv__0 t2)) LEFT JOIN (public.ft4__postgres_srv__0 t3)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c2, t3.c3
--          Relations: ((public.ft2__postgres_srv__0 t1) LEFT JOIN (public.ft2__postgres_srv__0 t2)) FULL JOIN (public.ft4__postgres_srv__0 t3)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c2, t3.c3
--          Relations: ((public.ft2__postgres_srv__0 t2) LEFT JOIN (public.ft2__postgres_srv__0 t1)) LEFT JOIN (public.ft4__postgres_srv__0 t3)
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c2, t3.c3
--          Relations: (public.ft4__postgres_srv__0 t3) LEFT JOIN ((public.ft2__postgres_srv__0 t1) INNER JOIN (public.ft2__postgres_srv__0 t2))
...
--          Relations: (public.ft1__postgres_srv__0 t1) FULL JOIN (public.ft2__postgres_srv__0 t2)
...
--                Output: t1.c1
--                Remote SQL: SELECT "C 1" FROM "S 1"."T 1" ORDER BY "C 1" ASC NULLS LAST
--          ->  Foreign Scan on public.ft2__postgres_srv__0 t2
--                Output: t2.c2
...
--    ->  Materialize
--          Output: (13)
--          ->  Foreign Scan on public.ft1__postgres_srv__0
--                Output: 13
...
-- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--  Nested Loop Left Join
--    Output: ft4__postgres_srv__0.c1, (13), ft1__postgres_srv__0.c1, ft2__postgres_srv__0.c1
--    Join Filter: (ft4__postgres_srv__0.c1 = ft1__postgres_srv__0.c1)
--    ->  Foreign Scan on public.ft4__postgres_srv__0
--          Output: ft4__postgres_srv__0.c1, ft4.c2, ft4.c3
--          Remote SQL: SELECT c1 FROM "S 1"."T 3" WHERE ((c1 >= 10)) AND ((c1 <= 15))
--    ->  Materialize
--          Output: ft1__postgres_srv__0.c1, ft2__postgres_srv__0.c1, (13)
--          ->  Foreign Scan
--                Output: ft1__postgres_srv__0.c1, ft2__postgres_srv__0.c1, 13
--                Relations: (public.ft1__postgres_srv__0) INNER JOIN (public.ft2__postgres_srv__0)
...
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--  Foreign Scan
--    Output: ft5__postgres_srv__0.*, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2
--    Relations: (public.ft5__postgres_srv__0) INNER JOIN (public.ft4__postgres_srv__0)
...
-- SELECT ft5__postgres_srv__0, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2 FROM ft5__postgres_srv__0 left join ft4__postgres_srv__0 on ft5__postgres_srv__0.c1 = ft4__postgres_srv__0.c1 WHERE ft4__postgres_srv__0.c1 BETWEEN 10 and 30 ORDER BY ft5__postgres_srv__0.c1, ft4__postgres_srv__0.c1;
--  ft5__postgres_srv__0 | c1 | c2 |   c3   | c1 | c2 
-- ----------------------+----+----+--------+----+----
...
-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--  LockRows
--    Output: ft1__postgres_srv__0.c1, ft1__postgres_srv__0.c2, ft1__postgres_srv__0.c3, ft1__postgres_srv__0.c4, ft1__postgres_srv__0.c5, ft1__postgres_srv__0.c6, ft1__postgres_srv__0.c7, ft1__postgres_srv__0.c8, ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c3, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3, ft1__postgres_srv__0.*, ft2__postgres_srv__0.*, ft4__postgres_srv__0.*, ft5__postgres_srv__0.*
--    ->  Foreign Scan
--          Output: ft1__postgres_srv__0.c1, ft1__postgres_srv__0.c2, ft1__postgres_srv__0.c3, ft1__postgres_srv__0.c4, ft1__postgres_srv__0.c5, ft1__postgres_srv__0.c6, ft1__postgres_srv__0.c7, ft1__postgres_srv__0.c8, ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c3, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3, ft1__postgres_srv__0.*, ft2__postgres_srv__0.*, ft4__postgres_srv__0.*, ft5__postgres_srv__0.*
--          Relations: (((public.ft1__postgres_srv__0) INNER JOIN (public.ft2__postgres_srv__0)) INNER JOIN (public.ft4__postgres_srv__0)) INNER JOIN (public.ft5__postgres_srv__0)
...
--          ->  Merge Join
--                Output: ft1__postgres_srv__0.c1, ft1__postgres_srv__0.c2, ft1__postgres_srv__0.c3, ft1__postgres_srv__0.c4, ft1__postgres_srv__0.c5, ft1__postgres_srv__0.c6, ft1__postgres_srv__0.c7, ft1__postgres_srv__0.c8, ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c3, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3, ft1__postgres_srv__0.*, ft2__postgres_srv__0.*, ft4__postgres_srv__0.*, ft5__postgres_srv__0.*
--                Merge Cond: (ft1__postgres_srv__0.c2 = ft5__postgres_srv__0.c1)
--                ->  Merge Join
--                      Output: ft1__postgres_srv__0.c1, ft1__postgres_srv__0.c2, ft1__postgres_srv__0.c3, ft1__postgres_srv__0.c4, ft1__postgres_srv__0.c5, ft1__postgres_srv__0.c6, ft1__postgres_srv__0.c7, ft1__postgres_srv__0.c8, ft1__postgres_srv__0.*, ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c3, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft2__postgres_srv__0.*, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft4__postgres_srv__0.*
--                      Merge Cond: (ft1__postgres_srv__0.c2 = ft4__postgres_srv__0.c1)
--                      ->  Sort
--                            Output: ft1__postgres_srv__0.c1, ft1__postgres_srv__0.c2, ft1__postgres_srv__0.c3, ft1__postgres_srv__0.c4, ft1__postgres_srv__0.c5, ft1__postgres_srv__0.c6, ft1__postgres_srv__0.c7, ft1__postgres_srv__0.c8, ft1__postgres_srv__0.*, ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c3, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft2__postgres_srv__0.*
--                            Sort Key: ft1__postgres_srv__0.c2
--                            ->  Merge Join
--                                  Output: ft1__postgres_srv__0.c1, ft1__postgres_srv__0.c2, ft1__postgres_srv__0.c3, ft1__postgres_srv__0.c4, ft1__postgres_srv__0.c5, ft1__postgres_srv__0.c6, ft1__postgres_srv__0.c7, ft1__postgres_srv__0.c8, ft1__postgres_srv__0.*, ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c3, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft2__postgres_srv__0.*
--                                  Merge Cond: (ft1__postgres_srv__0.c1 = ft2__postgres_srv__0.c1)
--                                  ->  Sort
--                                        Output: ft1__postgres_srv__0.c1, ft1__postgres_srv__0.c2, ft1__postgres_srv__0.c3, ft1__postgres_srv__0.c4, ft1__postgres_srv__0.c5, ft1__postgres_srv__0.c6, ft1__postgres_srv__0.c7, ft1__postgres_srv__0.c8, ft1__postgres_srv__0.*
--                                        Sort Key: ft1__postgres_srv__0.c1
--                                        ->  Foreign Scan on public.ft1__postgres_srv__0
--                                              Output: ft1__postgres_srv__0.c1, ft1__postgres_srv__0.c2, ft1__postgres_srv__0.c3, ft1__postgres_srv__0.c4, ft1__postgres_srv__0.c5, ft1__postgres_srv__0.c6, ft1__postgres_srv__0.c7, ft1__postgres_srv__0.c8, ft1__postgres_srv__0.*
...
--                      ->  Sort
--                            Output: ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft4__postgres_srv__0.*
--                            Sort Key: ft4__postgres_srv__0.c1
--                            ->  Foreign Scan on public.ft4__postgres_srv__0
--                                  Output: ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft4__postgres_srv__0.*
--                                  Remote SQL: SELECT c1, c2, c3 FROM "S 1"."T 3" FOR UPDATE
--                ->  Sort
--                      Output: ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3, ft5__postgres_srv__0.*
--                      Sort Key: ft5__postgres_srv__0.c1
--                      ->  Foreign Scan on public.ft5__postgres_srv__0
--                            Output: ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3, ft5__postgres_srv__0.*
...
-- ----------------------------------------------------------------------
--  Limit
--    Output: ft4__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c1
--    ->  Sort
--          Output: ft4__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c1
--          Sort Key: ft4__postgres_srv__0.c1, ft5__postgres_srv__0.c1
--          ->  Hash Left Join
--                Output: ft4__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c1
--                Hash Cond: (ft4__postgres_srv__0.c1 = ft5__postgres_srv__0.c1)
--                ->  Foreign Scan on public.ft4__postgres_srv__0
--                      Output: ft4__postgres_srv__0.c1, ft4.c2, ft4.c3
--                      Remote SQL: SELECT c1 FROM "S 1"."T 3"
--                ->  Hash
--                      Output: ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c1
--                      ->  Foreign Scan on public.ft5__postgres_srv__0
--                            Output: ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c1
...
-- -- Expected: EXPLAIN (VERBOSE, COSTS OFF)
-- SELECT t1.c1, t2.c2 FROM v4 t1 LEFT JOIN v5 t2 ON (t1.c1 = t2.c1) ORDER BY t1.c1, t2.c1 OFFSET 10 LIMIT 10;  -- can be pushed down
--                               QUERY PLAN                              
-- ----------------------------------------------------------------------
--  Limit
...
--    ->  Foreign Scan
--          Output: ft4__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c1
--          Relations: (public.ft4__postgres_srv__0) LEFT JOIN (public.ft5__postgres_srv__0)
...
-- ----------------------------------------------------------------------
--  Limit
--    Output: ft4__postgres_srv__0.c1, t2.c2, t2.c1
--    ->  Sort
--          Output: ft4__postgres_srv__0.c1, t2.c2, t2.c1
--          Sort Key: ft4__postgres_srv__0.c1, t2.c1
--          ->  Hash Left Join
--                Output: ft4__postgres_srv__0.c1, t2.c2, t2.c1
--                Hash Cond: (ft4__postgres_srv__0.c1 = t2.c1)
--                ->  Foreign Scan on public.ft4__postgres_srv__0
--                      Output: ft4__postgres_srv__0.c1, ft4.c2, ft4.c3
--                      Remote SQL: SELECT c1 FROM "S 1"."T 3"
--                ->  Hash
--                      Output: t2.c2, t2.c1
--                      ->  Foreign Scan on public.ft5__postgres_srv__0 t2
--                            Output: t2.c2, t2.c1
--                            Remote SQL: SELECT c1, c2 FROM "S 1"."T 4"
-- (16 rows)
...
--    ->  Foreign Scan
--          Output: ft4__postgres_srv__0.c1, t2.c2, t2.c1
--          Relations: (public.ft4__postgres_srv__0) LEFT JOIN (public.ft5__postgres_srv__0 t2)
...
-- ------------------------------------------------------------------------------------------------------------------------------------------------------
--  Result
--    Output: (count(c6)), (sum(c1)), (avg(c1)), (min(c2)), (max(c1)), (stddev(c2)), ((sum(c1)) * ((random() <= 'postgres'::double precision))::integer), c2
--    ->  Sort
--          Output: (count(c6)), (sum(c1)), (avg(c1)), (min(c2)), (max(c1)), (stddev(c2)), c2
--          Sort Key: (count(ft1__postgres_srv__0.c6)), (sum(ft1__postgres_srv__0.c1))
--          ->  Foreign Scan
--                Output: (count(c6)), (sum(c1)), (avg(c1)), (min(c2)), (max(c1)), (stddev(c2)), c2
...
--    Relations: Aggregate on ((public.ft1__postgres_srv__0 t1) INNER JOIN (public.ft1__postgres_srv__0 t2))
...
--    ->  Foreign Scan
--          Output: t1.c1, t2.c1
--          Filter: (((((t1.c1 * t2.c1) / (t1.c1 * t2.c1)))::double precision * random()) <= 'postgres'::double precision)
--          Relations: (public.ft1__postgres_srv__0 t1) INNER JOIN (public.ft2__postgres_srv__0 t2)
--          Remote SQL: SELECT r1."C 1", r2."C 1" FROM ("S 1"."T 1" r1 INNER JOIN "S 1"."T 1" r2 ON (((r1."C 1" = r2."C 1"))))
-- (7 rows)
...
--  Sort
--    Output: c2, c2, (sum(c1))
--    Sort Key: (sum(ft1__postgres_srv__0.c1))
--    ->  Foreign Scan
--          Output: c2, c2, (sum(c1))
--          Relations: Aggregate on (public.ft1__postgres_srv__0)
...
--    ->  HashAggregate
--          Output: sum(c1), c2
--          Group Key: ft1__postgres_srv__0.c2
--          Filter: (avg((ft1__postgres_srv__0.c1 * ((random() <= 'postgres'::double precision))::integer)) > '100'::numeric)
--          ->  Foreign Scan on public.ft1__postgres_srv__0
--                Output: c1, c2
...
--    ->  Foreign Scan
--          Output: (array_agg(DISTINCT (t1.c1 % 5))), ((t2.c1 % 3))
--          Relations: Aggregate on ((public.ft4__postgres_srv__0 t1) FULL JOIN (public.ft5__postgres_srv__0 t2))
...
--          ->  Foreign Scan
--                Output: (SubPlan 1)
--                Relations: Aggregate on (public.ft2__postgres_srv__0 t2)
...
-- ------------------------------------------------------------------------------------------------------------------------
--  Sort
--    Output: (sum(c1) FILTER (WHERE ((((c1 / c1))::double precision * random()) <= 'postgres'::double precision))), c2
--    Sort Key: (sum(ft1.c1) FILTER (WHERE ((((ft1.c1 / ft1.c1))::double precision * random()) <= 'postgres'::double precision)))
--    ->  HashAggregate
--          Output: sum(c1) FILTER (WHERE ((((c1 / c1))::double precision * random()) <= 'postgres'::double precision)), c2
--          Group Key: ft1__postgres_srv__0.c2
--          ->  Foreign Scan on public.ft1__postgres_srv__0
...
--    Group Key: ft2__postgres_srv__0.c2
...
--                Output: x.b
--                Inner Unique: true
--                Hash Cond: (ft1__postgres_srv__0.c2 = x.a)
--                ->  Foreign Scan on public.ft1__postgres_srv__0
--                      Output: ft1__postgres_srv__0.c2
...
--                            Output: x.b, x.a
--                            ->  Foreign Scan
--                                  Output: ft1__postgres_srv__0_1.c2, (sum(ft1__postgres_srv__0_1.c1))
--                                  Relations: Aggregate on (public.ft1__postgres_srv__0)
...
-- ------------------------------------------------------------------------------------------------
--  Foreign Scan
--    Output: (count(*)), (sum(ft4__postgres_srv__0.c1)), (avg(ft5__postgres_srv__0.c1))
--    Relations: Aggregate on ((public.ft4__postgres_srv__0) FULL JOIN (public.ft5__postgres_srv__0))
...
--    ->  Materialize
--          Output: ref_3.c3
--          ->  Foreign Scan on public.ft2__postgres_srv__0 ref_3
--                Output: ref_3.c3
--                Remote SQL: SELECT c3 FROM "S 1"."T 1" WHERE ((c3 = '00001'::text))
-- (15 rows)
...
--          Output: q.a, q.b
--          Inner Unique: true
--          Join Filter: ((ft4__postgres_srv__0.c1)::numeric <= q.b)
--          ->  Foreign Scan on public.ft4__postgres_srv__0
--                Output: ft4__postgres_srv__0.c1
--                Remote SQL: SELECT c1 FROM "S 1"."T 3"
--          ->  Materialize
--                Output: q.a, q.b
--                ->  Subquery Scan on q
--                      Output: q.a, q.b
--                      ->  Foreign Scan
--                            Output: 13, (avg(ft1__postgres_srv__0.c1)), NULL::bigint
--                            Relations: Aggregate on ((public.ft2__postgres_srv__0) LEFT JOIN (public.ft1__postgres_srv__0))
...
--    ->  Sort
--          Output: ((sum(c1) / 1000)), c2
--          Sort Key: ((sum(ft2__postgres_srv__0.c1) / 1000))
--          ->  Foreign Scan
--                Output: ((sum(c1) / 1000)), c2
--                Relations: Aggregate on (public.ft2__postgres_srv__0)
...
-- CONTEXT:  column "c8" of foreign table "ft1__postgres_srv__0"
...
-- ERROR:  invalid input syntax for integer: "foo"
-- CONTEXT:  whole-row reference to foreign table "ft1__postgres_srv__0"
...
--          ->  Limit
--                Output: ((ft2__postgres_srv__0_1.c1 + 1000)), ((ft2__postgres_srv__0_1.c2 + 100)), ((ft2__postgres_srv__0_1.c3 || ft2__postgres_srv__0_1.c3))
--                ->  Foreign Scan on public.ft2__postgres_srv__0 ft2__postgres_srv__0_1
--                      Output: (ft2__postgres_srv__0_1.c1 + 1000), (ft2__postgres_srv__0_1.c2 + 100), (ft2__postgres_srv__0_1.c3 || ft2__postgres_srv__0_1.c3)
...
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--  Update on public.ft2__postgres_srv__0
--    Output: ft2__postgres_srv__0.*, ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c3, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft4__postgres_srv__0.*, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3
--    ->  Foreign Update
...
-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--  Update on public.ft2__postgres_srv__0
--    Output: ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c3, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3
--    Remote SQL: UPDATE "S 1"."T 1" SET c3 = $2 WHERE ctid = $1 RETURNING "C 1", c2, c3, c4, c5, c6, c7, c8
--    ->  Nested Loop
--          Output: ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, NULL::integer, 'baz'::text, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft2__postgres_srv__0.ctid, ft4__postgres_srv__0.*, ft5__postgres_srv__0.*, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3
--          Join Filter: (ft2__postgres_srv__0.c2 === ft4__postgres_srv__0.c1)
--          ->  Foreign Scan on public.ft2__postgres_srv__0
--                Output: ft2__postgres_srv__0.c1, ft2__postgres_srv__0.c2, ft2__postgres_srv__0.c4, ft2__postgres_srv__0.c5, ft2__postgres_srv__0.c6, ft2__postgres_srv__0.c7, ft2__postgres_srv__0.c8, ft2__postgres_srv__0.ctid
--                Remote SQL: SELECT "C 1", c2, c4, c5, c6, c7, c8, ctid FROM "S 1"."T 1" WHERE (("C 1" > 2000)) FOR UPDATE
--          ->  Materialize
--                Output: ft4__postgres_srv__0.*, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft5__postgres_srv__0.*, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3
--                ->  Foreign Scan
--                      Output: ft4__postgres_srv__0.*, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3, ft5__postgres_srv__0.*, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3
--                      Relations: (public.ft4__postgres_srv__0) INNER JOIN (public.ft5__postgres_srv__0)
...
--                            Hash Cond: (ft4__postgres_srv__0.c1 = ft5__postgres_srv__0.c1)
--                            ->  Foreign Scan on public.ft4__postgres_srv__0
--                                  Output: ft4__postgres_srv__0.*, ft4__postgres_srv__0.c1, ft4__postgres_srv__0.c2, ft4__postgres_srv__0.c3
--                                  Remote SQL: SELECT c1, c2, c3 FROM "S 1"."T 3"
--                            ->  Hash
--                                  Output: ft5__postgres_srv__0.*, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3
--                                  ->  Foreign Scan on public.ft5__postgres_srv__0
--                                        Output: ft5__postgres_srv__0.*, ft5__postgres_srv__0.c1, ft5__postgres_srv__0.c2, ft5__postgres_srv__0.c3
...
--                                             QUERY PLAN                                            
-- --------------------------------------------------------------------------------------------------
--  Update on public.foreign_tbl__postgres_srv__0
--    Remote SQL: UPDATE public.base_tbl SET b = $2 WHERE ctid = $1
--    ->  Foreign Scan on public.foreign_tbl__postgres_srv__0
--          Output: foreign_tbl__postgres_srv__0.a, 20, foreign_tbl__postgres_srv__0.ctid
...
--    Remote SQL: UPDATE public.base_tbl SET b = $2 WHERE ctid = $1
--    ->  Foreign Scan on public.foreign_tbl__postgres_srv__0
--          Output: foreign_tbl__postgres_srv__0.a, '-20'::integer, foreign_tbl__postgres_srv__0.ctid
--          Remote SQL: SELECT a, ctid FROM public.base_tbl WHERE ((a < b)) AND ((a = 0)) FOR UPDATE
-- (5 rows)
...
-- -----------------------------------------------------------------------
--  Update on public.rem1__postgres_srv__0
--    Remote SQL: UPDATE public.loc1_1 SET f2 = $2 WHERE ctid = $1
--    ->  Foreign Scan on public.rem1__postgres_srv__0
--          Output: f1, ''::text, ctid, rem1__postgres_srv__0.*
...
--    Output: parent.a, parent.b, remt2__postgres_srv__0.a, remt2__postgres_srv__0.b
--    Update on public.parent
--    Foreign Update on public.remt1__postgres_srv__0
--    ->  Nested Loop
--          Output: parent.a, (parent.b || remt2__postgres_srv__0.b), parent.ctid, remt2__postgres_srv__0.*, remt2__postgres_srv__0.a, remt2__postgres_srv__0.b
--          Join Filter: (parent.a = remt2__postgres_srv__0.a)
--          ->  Seq Scan on public.parent
--                Output: parent.a, parent.b, parent.ctid
--          ->  Foreign Scan on public.remt2__postgres_srv__0
--                Output: remt2__postgres_srv__0.b, remt2__postgres_srv__0.*, remt2__postgres_srv__0.a
--                Remote SQL: SELECT a, b FROM public.loct2_2
--    ->  Foreign Update
--          Remote SQL: UPDATE public.loct1_2 r4 SET b = (r4.b || r2.b) FROM public.loct2_2 r2 WHERE ((r4.a = r2.a)) RETURNING r4.a, r4.b, r2.a, r2.b
-- (14 rows)
...
--    Output: parent.*
--    Delete on public.parent
--    Foreign Delete on public.remt1__postgres_srv__0
--    ->  Nested Loop
--          Output: parent.ctid, remt2__postgres_srv__0.*
--          Join Filter: (parent.a = remt2__postgres_srv__0.a)
--          ->  Seq Scan on public.parent
--                Output: parent.ctid, parent.a
--          ->  Foreign Scan on public.remt2__postgres_srv__0
--                Output: remt2__postgres_srv__0.*, remt2__postgres_srv__0.a
--                Remote SQL: SELECT a, b FROM public.loct2_2
--    ->  Foreign Delete
--          Remote SQL: DELETE FROM public.loct1_2 r4 USING public.loct2_2 r2 WHERE ((r4.a = r2.a)) RETURNING r4.a, r4.b
-- (14 rows)
...
--         tableoid        | a |  b  
-- ------------------------+---+-----
--  remp1__postgres_srv__0 | 1 | foo
--  remp2__postgres_srv__0 | 2 | baz
--  remp2__postgres_srv__0 | 2 | qux
-- (3 rows)
...
--         tableoid        |  b  | a 
-- ------------------------+-----+---
--  remp2__postgres_srv__0 | baz | 2
--  remp2__postgres_srv__0 | qux | 2
-- (2 rows)
...
-- CONTEXT:  remote SQL command: UPDATE public.loct_2 SET a = 2 WHERE ((b = 'foo'::text)) RETURNING a, b
-- -- But the reverse is allowed
-- update utrtest set a = 1 where b = 'qux' returning *;
--  a |  b  
-- ---+-----
...
--    Output: remp__postgres_srv__0.a, remp__postgres_srv__0.b
--    Foreign Update on public.remp__postgres_srv__0
--    Update on public.locp
--    ->  Foreign Update on public.remp__postgres_srv__0
--          Remote SQL: UPDATE public.loct_2 SET a = 1 WHERE (((a = 1) OR (a = 2))) RETURNING a, b
...
--    Update on public.locp
--    ->  Foreign Update on public.remp__postgres_srv__0
--          Remote SQL: UPDATE public.loct_2 SET a = 1 RETURNING a, b
--    ->  Seq Scan on public.locp
--          Output: 1, locp.b, locp.ctid
-- (8 rows)
...
-- ----------------------------------------------------------------------------------------------------------
--  Update on public.utrtest
--    Output: remp__postgres_srv__0.a, remp__postgres_srv__0.b, "*VALUES*".column1
--    Foreign Update on public.remp__postgres_srv__0
--      Remote SQL: UPDATE public.loct_2 SET a = $2 WHERE ctid = $1 RETURNING a, b
--    Update on public.locp
--    ->  Hash Join
--          Output: 1, remp__postgres_srv__0.b, remp__postgres_srv__0.ctid, "*VALUES*".*, "*VALUES*".column1
--          Hash Cond: (remp__postgres_srv__0.a = "*VALUES*".column1)
--          ->  Foreign Scan on public.remp__postgres_srv__0
--                Output: remp__postgres_srv__0.b, remp__postgres_srv__0.ctid, remp__postgres_srv__0.a
--                Remote SQL: SELECT a, b, ctid FROM public.loct_2 FOR UPDATE
--          ->  Hash
...
-- 	for each row execute procedure trig_row_before_insupdate();
-- copy rem2__postgres_srv__0 from stdin;
-- NOTICE:  rem2__postgres_srv__0_trig_row_before(23, skidoo) BEFORE ROW INSERT ON rem2__postgres_srv__0
-- NOTICE:  NEW: (1,"foo triggered !")
-- NOTICE:  rem2__postgres_srv__0_trig_row_before(23, skidoo) BEFORE ROW INSERT ON rem2__postgres_srv__0
-- NOTICE:  NEW: (2,"bar triggered !")
-- NOTICE:  rem2__postgres_srv__0_trig_row_after(23, skidoo) AFTER ROW INSERT ON rem2__postgres_srv__0
-- NOTICE:  NEW: (1,"foo triggered !")
-- NOTICE:  rem2__postgres_srv__0_trig_row_after(23, skidoo) AFTER ROW INSERT ON rem2__postgres_srv__0
-- NOTICE:  NEW: (2,"bar triggered !")
-- select * from rem2__postgres_srv__0;
...
CREATE FOREIGN TABLE fpagg_tab_p1 PARTITION OF pagg_tab FOR VALUES FROM (0) TO (10) SERVER pgspider_srv;
CREATE FOREIGN TABLE fpagg_tab_p2 PARTITION OF pagg_tab FOR VALUES FROM (10) TO (20) SERVER pgspider_srv;
CREATE FOREIGN TABLE fpagg_tab_p3 PARTITION OF pagg_tab FOR VALUES FROM (20) TO (30) SERVER pgspider_srv;
...
--          ->  Hash Full Join
--                Hash Cond: (ftprt1_p2__postgres_srv__0.a = ftprt2_p2__postgres_srv__0.b)
