...
--Testcase 2:
CREATE EXTENSION :source_wrapper_name;
--Testcase 3:
CREATE EXTENSION IF NOT EXISTS :dest_wrapper_name;
-- Source: init SERVER, USER MAPPING
--Testcase 4:
CREATE SERVER source_svr FOREIGN DATA WRAPPER :source_wrapper_name OPTIONS (:source_server_opt);
--Testcase 5:
CREATE SERVER dest_svr FOREIGN DATA WRAPPER :dest_wrapper_name OPTIONS (:dest_server_opt);

--Testcase 6:
CREATE USER MAPPING FOR CURRENT_USER SERVER source_svr OPTIONS (:source_usermapping_opt);
--Testcase 7:
CREATE USER MAPPING FOR CURRENT_USER SERVER dest_svr OPTIONS (:dest_usermapping_opt);
...
CREATE FOREIGN TABLE ft1 (
	...
	c7 text,
	c8 text
) SERVER source_svr OPTIONS (:source_foreigntable_opt);
...
CREATE FOREIGN TABLE tmp_ftbl (
	...
	c7 text,
	c8 text
) SERVER dest_svr OPTIONS (:tmp_dest_foreigntable_opt);
...
--Testcase 334:
DROP EXTENSION :source_wrapper_name CASCADE;
--Testcase 335:
DROP EXTENSION IF EXISTS :dest_wrapper_name CASCADE;
