...
CREATE FOREIGN TABLE mindate (i date) SERVER pgspider2;
CREATE FOREIGN TABLE mindate__postgresql2__0 (i date) SERVER postgresql2 OPTIONS (table_name 'mindate');
CREATE FOREIGN TABLE mindate__csv__0 (i date) SERVER csv OPTIONS (filename '/tmp/mindate.csv', format 'csv');
