...
CREATE FOREIGN TABLE avgsmallint (i smallint) SERVER pgspider2;
CREATE FOREIGN TABLE avgsmallint__postgresql2__0(i smallint) SERVER postgresql2 OPTIONS (table_name 'avgsmallint');
CREATE FOREIGN TABLE avgsmallint__csv__0(i smallint) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/avgsmallint.csv');
