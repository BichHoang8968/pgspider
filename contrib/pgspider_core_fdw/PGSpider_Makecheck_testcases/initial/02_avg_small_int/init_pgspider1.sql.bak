...
CREATE FOREIGN TABLE avgsmallint (i smallint) SERVER pgspider1;
CREATE FOREIGN TABLE avgsmallint__postgresql1__0 (i smallint) SERVER postgresql1 OPTIONS (table_name 'avgsmallint');
CREATE FOREIGN TABLE avgsmallint__pgspider2__0 (i smallint) SERVER pgspider2 OPTIONS (table_name 'avgsmallint');
CREATE FOREIGN TABLE avgsmallint__sqlite__0 (i smallint) SERVER sqlite OPTIONS (table 'avgsmallint');
