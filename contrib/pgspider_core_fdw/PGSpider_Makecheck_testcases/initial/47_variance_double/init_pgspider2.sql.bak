...
CREATE FOREIGN TABLE variancedouble (i double precision) SERVER pgspider2;
CREATE FOREIGN TABLE variancedouble__postgresql2__0 (i double precision) SERVER postgresql2 OPTIONS (table_name 'variancedouble');
CREATE FOREIGN TABLE variancedouble__csv__0 (i double precision) SERVER csv OPTIONS (filename '/tmp/variancedouble.csv', format 'csv');
