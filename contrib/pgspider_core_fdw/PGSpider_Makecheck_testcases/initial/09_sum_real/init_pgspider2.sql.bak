...
CREATE FOREIGN TABLE sumreal (i real) SERVER pgspider2;
CREATE FOREIGN TABLE sumreal__postgresql2__0(i real) SERVER postgresql2 OPTIONS (table_name 'sumreal');
CREATE FOREIGN TABLE sumreal__csv__0(i real) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/sumreal.csv');
