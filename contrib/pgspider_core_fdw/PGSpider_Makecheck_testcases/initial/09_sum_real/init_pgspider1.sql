...
CREATE FOREIGN TABLE sumreal (i real) SERVER pgspider1;
CREATE FOREIGN TABLE sumreal__postgresql1__0 (i real) SERVER postgresql1 OPTIONS (table_name 'sumreal');
CREATE FOREIGN TABLE sumreal__pgspider2__0 (i real) SERVER pgspider2 OPTIONS (table_name 'sumreal');
CREATE FOREIGN TABLE sumreal__sqlite__0 (i real) SERVER sqlite OPTIONS (table 'sumreal');
