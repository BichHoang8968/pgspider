...
CREATE FOREIGN TABLE sumdouble (i double precision) SERVER pgspider2;
CREATE FOREIGN TABLE sumdouble__postgresql2__0(i double precision) SERVER postgresql2 OPTIONS (table_name 'sumdouble');
CREATE FOREIGN TABLE sumdouble__csv__0(i double precision) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/sumdouble.csv');
