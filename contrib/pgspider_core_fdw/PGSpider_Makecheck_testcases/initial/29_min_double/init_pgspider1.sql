...
CREATE FOREIGN TABLE mindouble (i double precision) SERVER pgspider1;
CREATE FOREIGN TABLE mindouble__pgspider2__0 (i double precision) SERVER pgspider2 OPTIONS (table_name 'mindouble');
CREATE FOREIGN TABLE mindouble__postgresql1__0 (i double precision) SERVER postgresql1 OPTIONS (table_name 'mindouble');
CREATE FOREIGN TABLE mindouble__sqlite__0 (i double precision) SERVER sqlite OPTIONS (table 'mindouble');
