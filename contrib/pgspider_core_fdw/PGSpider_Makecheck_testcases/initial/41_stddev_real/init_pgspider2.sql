...
CREATE FOREIGN TABLE stddevreal (i real) SERVER pgspider2;
CREATE FOREIGN TABLE stddevreal__postgresql2__0 (i real) SERVER postgresql2 OPTIONS (table_name 'stddevreal');
CREATE FOREIGN TABLE stddevreal__csv__0 (i real) SERVER csv OPTIONS (filename '/tmp/stddevreal.csv', format 'csv');
