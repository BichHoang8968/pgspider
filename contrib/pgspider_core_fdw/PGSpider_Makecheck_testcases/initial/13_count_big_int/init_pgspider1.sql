...
CREATE FOREIGN TABLE countbigint (i bigint) SERVER pgspider1;
CREATE FOREIGN TABLE countbigint__postgresql1__0 (i bigint) SERVER postgresql1 OPTIONS (table_name 'countbigint');
CREATE FOREIGN TABLE countbigint__pgspider2__0 (i bigint) SERVER pgspider2 OPTIONS (table_name 'countbigint');
CREATE FOREIGN TABLE countbigint__sqlite__0 (i bigint) SERVER sqlite OPTIONS (table 'countbigint');
