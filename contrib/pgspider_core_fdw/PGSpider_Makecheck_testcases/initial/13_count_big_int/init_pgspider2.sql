...
CREATE FOREIGN TABLE countbigint (i bigint) SERVER pgspider2;
CREATE FOREIGN TABLE countbigint__postgresql2__0(i bigint) SERVER postgresql2 OPTIONS (table_name 'countbigint');
CREATE FOREIGN TABLE countbigint__csv__0(i bigint) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/countbigint.csv');
