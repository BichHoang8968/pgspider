...
CREATE FOREIGN TABLE bitandbigint (i bigint) SERVER pgspider2;
CREATE FOREIGN TABLE bitandbigint__postgresql2__0 (i bigint) SERVER postgresql2 OPTIONS (table_name 'bitandbigint');
CREATE FOREIGN TABLE bitandbigint__csv__0 (i bigint) SERVER csv OPTIONS (filename '/tmp/bitandbigint.csv', format 'csv');
