...
CREATE FOREIGN TABLE countreal (i real) SERVER pgspider1;
CREATE FOREIGN TABLE countreal__postgresql1__0 (i real) SERVER postgresql1 OPTIONS (table_name 'countreal');
CREATE FOREIGN TABLE countreal__pgspider2__0 (i real) SERVER pgspider2 OPTIONS (table_name 'countreal');
CREATE FOREIGN TABLE countreal__sqlite__0 (i real) SERVER sqlite OPTIONS (table 'countreal');
