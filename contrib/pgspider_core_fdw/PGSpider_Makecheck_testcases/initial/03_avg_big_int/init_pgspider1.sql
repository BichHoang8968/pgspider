...
CREATE FOREIGN TABLE avgbigint (i bigint) SERVER pgspider1;
CREATE FOREIGN TABLE avgbigint__postgresql1__0 (i bigint) SERVER postgresql1 OPTIONS (table_name 'avgbigint');
CREATE FOREIGN TABLE avgbigint__pgspider2__0 (i bigint) SERVER pgspider2 OPTIONS (table_name 'avgbigint');
CREATE FOREIGN TABLE avgbigint__sqlite__0 (i bigint) SERVER sqlite OPTIONS (table 'avgbigint');
