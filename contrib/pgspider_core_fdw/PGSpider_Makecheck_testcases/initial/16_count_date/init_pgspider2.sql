...
CREATE FOREIGN TABLE countdate (i date) SERVER pgspider2;
CREATE FOREIGN TABLE countdate__postgresql2__0(i date) SERVER postgresql2 OPTIONS (table_name 'countdate');
CREATE FOREIGN TABLE countdate__csv__0(i date) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/countdate.csv');
