...
CREATE FOREIGN TABLE countdate (i date) SERVER pgspider1;
CREATE FOREIGN TABLE countdate__postgresql1__0 (i date) SERVER postgresql1 OPTIONS (table_name 'countdate');
CREATE FOREIGN TABLE countdate__pgspider2__0 (i date) SERVER pgspider2 OPTIONS (table_name 'countdate');
CREATE FOREIGN TABLE countdate__sqlite__0 (i date) SERVER sqlite OPTIONS (table 'countdate');
