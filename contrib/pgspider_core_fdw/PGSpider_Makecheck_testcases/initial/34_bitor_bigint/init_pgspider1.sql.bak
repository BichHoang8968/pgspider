...
CREATE FOREIGN TABLE bitorbigint (i bigint) SERVER pgspider1;
CREATE FOREIGN TABLE bitorbigint__pgspider2__0 (i bigint) SERVER pgspider2 OPTIONS (table_name 'bitorbigint');
CREATE FOREIGN TABLE bitorbigint__postgresql1__0 (i bigint) SERVER postgresql1 OPTIONS (table_name 'bitorbigint');
CREATE FOREIGN TABLE bitorbigint__sqlite__0 (i bigint) SERVER sqlite OPTIONS (table 'bitorbigint');
