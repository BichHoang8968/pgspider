...
CREATE FOREIGN TABLE maxdouble (i double precision) SERVER pgspider2;
CREATE FOREIGN TABLE maxdouble__postgresql2__0(i double precision) SERVER postgresql2 OPTIONS (table_name 'maxdouble');
CREATE FOREIGN TABLE maxdouble__csv__0(i double precision) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/maxdouble.csv');
