...
CREATE FOREIGN TABLE maxstring (i text) SERVER pgspider1;
CREATE FOREIGN TABLE maxstring__postgresql1__0 (i text) SERVER postgresql1 OPTIONS (table_name 'maxstring');
CREATE FOREIGN TABLE maxstring__pgspider2__0 (i text) SERVER pgspider2 OPTIONS (table_name 'maxstring');
CREATE FOREIGN TABLE maxstring__sqlite__0 (i text) SERVER sqlite OPTIONS (table 'maxstring');
