...
CREATE FOREIGN TABLE varianceint (i int) SERVER pgspider1;
CREATE FOREIGN TABLE varianceint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'varianceint');
CREATE FOREIGN TABLE varianceint__postgresql1__0 (i int) SERVER postgresql1 OPTIONS (table_name 'varianceint');
CREATE FOREIGN TABLE varianceint__sqlite__0 (i int) SERVER sqlite OPTIONS (table 'varianceint');
