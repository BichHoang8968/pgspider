...
CREATE FOREIGN TABLE bitandint (i int) SERVER pgspider1;
CREATE FOREIGN TABLE bitandint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'bitandint');
CREATE FOREIGN TABLE bitandint__postgresql1__0 (i int) SERVER postgresql1 OPTIONS (table_name 'bitandint');
CREATE FOREIGN TABLE bitandint__sqlite__0 (i int) SERVER sqlite OPTIONS (table 'bitandint');
