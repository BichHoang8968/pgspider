...
CREATE FOREIGN TABLE bitorint (i int) SERVER pgspider1;
CREATE FOREIGN TABLE bitorint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'bitorint');
CREATE FOREIGN TABLE bitorint__postgresql1__0 (i int) SERVER postgresql1 OPTIONS (table_name 'bitorint');
CREATE FOREIGN TABLE bitorint__sqlite__0 (i int) SERVER sqlite OPTIONS (table 'bitorint');
