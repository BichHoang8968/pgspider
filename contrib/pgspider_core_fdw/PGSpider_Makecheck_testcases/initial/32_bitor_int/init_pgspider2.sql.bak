...
CREATE FOREIGN TABLE bitorint (i int) SERVER pgspider2;
CREATE FOREIGN TABLE bitorint__postgresql2__0 (i int) SERVER postgresql2 OPTIONS (table_name 'bitorint');
CREATE FOREIGN TABLE bitorint__csv__0 (i int) SERVER csv OPTIONS (filename '/tmp/bitorint.csv', format 'csv');
