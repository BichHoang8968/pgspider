...
CREATE FOREIGN TABLE bitorsmallint (i smallint) SERVER pgspider2;
CREATE FOREIGN TABLE bitorsmallint__postgresql2__0 (i smallint) SERVER postgresql2 OPTIONS (table_name 'bitorsmallint');
CREATE FOREIGN TABLE bitorsmallint__csv__0 (i smallint) SERVER csv OPTIONS (filename '/tmp/bitorsmallint.csv', format 'csv');
