...
CREATE FOREIGN TABLE avgreal (i real) SERVER pgspider1;
CREATE FOREIGN TABLE avgreal__postgresql1__0 (i real) SERVER postgresql1 OPTIONS (table_name 'avgreal');
CREATE FOREIGN TABLE avgreal__pgspider2__0 (i real) SERVER pgspider2 OPTIONS (table_name 'avgreal');
CREATE FOREIGN TABLE avgreal__sqlite__0 (i real) SERVER sqlite OPTIONS (table 'avgreal');
