...
CREATE FOREIGN TABLE stddevint (i int) SERVER pgspider2;
CREATE FOREIGN TABLE stddevint__postgresql2__0 (i int) SERVER postgresql2 OPTIONS (table_name 'stddevint');
CREATE FOREIGN TABLE stddevint__csv__0 (i int) SERVER csv OPTIONS (filename '/tmp/stddevint.csv'. format 'csv');
