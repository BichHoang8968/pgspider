...
CREATE FOREIGN TABLE bitandsmallint (i smallint) SERVER pgspider2;
CREATE FOREIGN TABLE bitandsmallint__postgresql2__0 (i smallint) SERVER postgresql2 OPTIONS (table_name 'bitandsmallint');
CREATE FOREIGN TABLE bitandsmallint__csv__0 (i smallint) SERVER csv OPTIONS (filename '/tmp/bitandsmallint.csv', format 'csv');
