...
CREATE FOREIGN TABLE maxsmallint (i smallint) SERVER pgspider2;
CREATE FOREIGN TABLE maxsmallint__postgresql2__0(i smallint) SERVER postgresql2 OPTIONS (table_name 'maxsmallint');
CREATE FOREIGN TABLE maxsmallint__csv__0(i smallint) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/maxsmallint.csv');
