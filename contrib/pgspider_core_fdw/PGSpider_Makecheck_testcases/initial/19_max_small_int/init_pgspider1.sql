...
CREATE FOREIGN TABLE maxsmallint (i smallint) SERVER pgspider1;
CREATE FOREIGN TABLE maxsmallint__postgresql1__0 (i smallint) SERVER postgresql1 OPTIONS (table_name 'maxsmallint');
CREATE FOREIGN TABLE maxsmallint__pgspider2__0 (i smallint) SERVER pgspider2 OPTIONS (table_name 'maxsmallint');
CREATE FOREIGN TABLE maxsmallint__sqlite__0 (i smallint) SERVER sqlite OPTIONS (table 'maxsmallint');
