...
CREATE FOREIGN TABLE sumbigint (i bigint) SERVER pgspider2;
CREATE FOREIGN TABLE sumbigint__postgresql2__0(i bigint) SERVER postgresql2 OPTIONS (table_name 'sumbigint');
CREATE FOREIGN TABLE sumbigint__csv__0(i bigint) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/sumbigint.csv');
