...
CREATE FOREIGN TABLE stddevsmallint (i smallint) SERVER pgspider1;
CREATE FOREIGN TABLE stddevsmallint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'stddevsmallint');
CREATE FOREIGN TABLE stddevsmallint__postgresql1__0 (i smallint) SERVER postgresql1 OPTIONS (table_name 'stddevsmallint');
CREATE FOREIGN TABLE stddevsmallint__sqlite__0 (i smallint) SERVER sqlite OPTIONS (table 'stddevsmallint');
