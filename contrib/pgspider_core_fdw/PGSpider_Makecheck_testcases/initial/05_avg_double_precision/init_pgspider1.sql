...
CREATE FOREIGN TABLE avgdouble (i double precision) SERVER pgspider1;
CREATE FOREIGN TABLE avgdouble__postgresql1__0 (i double precision) SERVER postgresql1 OPTIONS (table_name 'avgdouble');
CREATE FOREIGN TABLE avgdouble__pgspider2__0 (i double precision) SERVER pgspider2 OPTIONS (table_name 'avgdouble');
CREATE FOREIGN TABLE avgdouble__sqlite__0 (i double precision) SERVER sqlite OPTIONS (table 'avgdouble');
