...
CREATE FOREIGN TABLE countint (i int) SERVER pgspider1;
CREATE FOREIGN TABLE countint__postgresql1__0 (i int) SERVER postgresql1 OPTIONS (table_name 'countint');
CREATE FOREIGN TABLE countint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'countint');
CREATE FOREIGN TABLE countint__sqlite__0 (i int) SERVER sqlite OPTIONS (table 'countint');
