...
CREATE FOREIGN TABLE minreal (i real) SERVER pgspider1;
CREATE FOREIGN TABLE minreal__pgspider2__0 (i real) SERVER pgspider2 OPTIONS (table_name 'minreal');
CREATE FOREIGN TABLE minreal__postgresql1__0 (i real) SERVER postgresql1 OPTIONS (table_name 'minreal');
CREATE FOREIGN TABLE minreal__sqlite__0 (i real) SERVER sqlite OPTIONS (table 'minreal');
