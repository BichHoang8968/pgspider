...
CREATE FOREIGN TABLE countsmallint (i smallint) SERVER pgspider1;
CREATE FOREIGN TABLE countsmallint__postgresql1__0 (i smallint) SERVER postgresql1 OPTIONS (table_name 'countsmallint');
CREATE FOREIGN TABLE countsmallint__pgspider2__0 (i smallint) SERVER pgspider2 OPTIONS (table_name 'countsmallint');
CREATE FOREIGN TABLE countsmallint__sqlite__0 (i smallint) SERVER sqlite OPTIONS (table 'countsmallint');
