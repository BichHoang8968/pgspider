...
CREATE FOREIGN TABLE countsmallint (i smallint) SERVER pgspider2;
CREATE FOREIGN TABLE countsmallint__postgresql2__0(i smallint) SERVER postgresql2 OPTIONS (table_name 'countsmallint');
CREATE FOREIGN TABLE countsmallint__csv__0(i smallint) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/countsmallint.csv');
