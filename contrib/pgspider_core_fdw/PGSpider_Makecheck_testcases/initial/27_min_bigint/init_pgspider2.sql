...
CREATE FOREIGN TABLE minbigint (i bigint) SERVER pgspider2;
CREATE FOREIGN TABLE minbigint__postgresql2__0 (i bigint) SERVER postgresql2 OPTIONS (table_name 'minbigint');
CREATE FOREIGN TABLE minbigint__csv__0 (i bigint) SERVER csv OPTIONS (filename '/tmp/minsmallint.csv', format 'csv');
