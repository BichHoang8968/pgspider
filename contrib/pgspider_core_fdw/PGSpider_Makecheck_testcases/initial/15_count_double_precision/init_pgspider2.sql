...
CREATE FOREIGN TABLE countdouble (i double precision) SERVER pgspider2;
CREATE FOREIGN TABLE countdouble__postgresql2__0(i double precision) SERVER postgresql2 OPTIONS (table_name 'countdouble');
CREATE FOREIGN TABLE countdouble__csv__0(i double precision) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/countdouble.csv');
