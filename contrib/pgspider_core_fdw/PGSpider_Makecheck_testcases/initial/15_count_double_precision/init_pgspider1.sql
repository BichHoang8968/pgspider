...
CREATE FOREIGN TABLE countdouble (i double precision) SERVER pgspider1;
CREATE FOREIGN TABLE countdouble__postgresql1__0 (i double precision) SERVER postgresql1 OPTIONS (table_name 'countdouble');
CREATE FOREIGN TABLE countdouble__pgspider2__0 (i double precision) SERVER pgspider2 OPTIONS (table_name 'countdouble');
CREATE FOREIGN TABLE countdouble__sqlite__0 (i double precision) SERVER sqlite OPTIONS (table 'countdouble');
