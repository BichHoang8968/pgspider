...
CREATE FOREIGN TABLE stddevbigint (i bigint) SERVER pgspider2;
CREATE FOREIGN TABLE stddevbigint__postgresql2__0 (i bigint) SERVER postgresql2 OPTIONS (table_name 'stddevbigint');
CREATE FOREIGN TABLE stddevbigint__csv__0 (i bigint) SERVER csv OPTIONS (filename '/tmp/stddevbigint.csv', format 'csv');
