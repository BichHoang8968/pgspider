...
CREATE FOREIGN TABLE sumint (i int) SERVER pgspider1;
CREATE FOREIGN TABLE sumint__postgresql1__0 (i int) SERVER postgresql1 OPTIONS (table_name 'sumint');
CREATE FOREIGN TABLE sumint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'sumint');
CREATE FOREIGN TABLE sumint__sqlite__0 (i int) SERVER sqlite OPTIONS (table 'sumint');
