...
CREATE FOREIGN TABLE sumint (i int) SERVER pgspider2;
CREATE FOREIGN TABLE sumint__postgresql2__0(i int) SERVER postgresql2 OPTIONS (table_name 'sumint');
CREATE FOREIGN TABLE sumint__csv__0(i int) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/sumint.csv');
