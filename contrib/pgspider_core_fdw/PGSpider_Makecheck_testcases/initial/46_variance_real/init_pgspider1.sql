...
CREATE FOREIGN TABLE variancereal (i real) SERVER pgspider1;
CREATE FOREIGN TABLE variancereal__pgspider2__0 (i real) SERVER pgspider2 OPTIONS (table_name 'variancereal');
CREATE FOREIGN TABLE variancereal__postgresql1__0 (i real) SERVER postgresql1 OPTIONS (table_name 'variancereal');
CREATE FOREIGN TABLE variancereal__sqlite__0 (i real) SERVER sqlite OPTIONS (table 'variancereal');
