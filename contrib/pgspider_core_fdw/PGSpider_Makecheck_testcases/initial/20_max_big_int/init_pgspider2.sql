...
CREATE FOREIGN TABLE maxbigint (i bigint) SERVER pgspider2;
CREATE FOREIGN TABLE maxbigint__postgresql2__0(i bigint) SERVER postgresql2 OPTIONS (table_name 'maxbigint');
CREATE FOREIGN TABLE maxbigint__csv__0(i bigint) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/maxbigint.csv');
