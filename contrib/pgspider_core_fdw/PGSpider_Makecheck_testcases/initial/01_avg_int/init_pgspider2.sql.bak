...
CREATE FOREIGN TABLE avgint (i int) SERVER pgspider2;
CREATE FOREIGN TABLE avgint__postgresql2__0(i int) SERVER postgresql2 OPTIONS (table_name 'avgint');
CREATE FOREIGN TABLE avgint__csv__0(i int) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/avgint.csv');
