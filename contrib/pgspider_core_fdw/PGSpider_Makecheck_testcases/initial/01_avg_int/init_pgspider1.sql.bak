...
CREATE FOREIGN TABLE avgint (i int) SERVER pgspider1;
CREATE FOREIGN TABLE avgint__postgresql1__0 (i int) SERVER postgresql1 OPTIONS (table_name 'avgint');
CREATE FOREIGN TABLE avgint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'avgint');
CREATE FOREIGN TABLE avgint__sqlite__0 (i int) SERVER sqlite OPTIONS (table 'avgint');
