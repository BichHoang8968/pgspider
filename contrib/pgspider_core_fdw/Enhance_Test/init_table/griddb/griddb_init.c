                        ...
                        const char *passwd)
{
  ...
  set_tableInfo(store, "t1", &TEST_TB_T1,
                  19,
                  "c1", GS_TYPE_INTEGER, GS_TYPE_OPTION_NOT_NULL,
                  "c2", GS_TYPE_STRING, GS_TYPE_OPTION_NULLABLE,
                  "c3", GS_TYPE_BYTE, GS_TYPE_OPTION_NULLABLE,
                  "c4", GS_TYPE_SHORT, GS_TYPE_OPTION_NULLABLE,
                  "c5", GS_TYPE_BOOL, GS_TYPE_OPTION_NULLABLE,
                  "c6", GS_TYPE_LONG, GS_TYPE_OPTION_NULLABLE,
                  "c7", GS_TYPE_FLOAT, GS_TYPE_OPTION_NULLABLE,
                  "c8", GS_TYPE_DOUBLE, GS_TYPE_OPTION_NULLABLE,
                  "c9", GS_TYPE_TIMESTAMP, GS_TYPE_OPTION_NULLABLE,
                  "c10", GS_TYPE_BLOB, GS_TYPE_OPTION_NULLABLE,
                  "c11", GS_TYPE_STRING_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c12", GS_TYPE_BOOL_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c13", GS_TYPE_BYTE_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c14", GS_TYPE_SHORT_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c15", GS_TYPE_INTEGER_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c16", GS_TYPE_LONG_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c17", GS_TYPE_FLOAT_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c18", GS_TYPE_DOUBLE_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c19", GS_TYPE_TIMESTAMP_ARRAY, GS_TYPE_OPTION_NULLABLE
                  //"c20", GS_TYPE_GEOMETRY, GS_TYPE_OPTION_NULLABLE,
                  );
  insertRecordsFromTSV (store, &TEST_TB_T1, "/tmp/griddb_enhance_t1.data");

  table_info TEST_TB_T2;
  set_tableInfo(store, "t2", &TEST_TB_T2,
                  3,
                  "c1", GS_TYPE_INTEGER, GS_TYPE_OPTION_NOT_NULL,
                  "c2", GS_TYPE_STRING, GS_TYPE_OPTION_NULLABLE,
                  "c3", GS_TYPE_TIMESTAMP, GS_TYPE_OPTION_NULLABLE
                  //"c20", GS_TYPE_GEOMETRY, GS_TYPE_OPTION_NULLABLE,
                  );
  insertRecordsFromTSV (store, &TEST_TB_T2, "/tmp/griddb_enhance_t2.data");

  table_info TEST_TB_T15;
  set_tableInfo(store, "tmp_t15", &TEST_TB_T15,
                  4,
                  "time", GS_TYPE_TIMESTAMP, GS_TYPE_OPTION_NOT_NULL,
                  "c2", GS_TYPE_STRING, GS_TYPE_OPTION_NULLABLE,
                  "c3", GS_TYPE_LONG, GS_TYPE_OPTION_NULLABLE,
                  "c4", GS_TYPE_DOUBLE, GS_TYPE_OPTION_NULLABLE
                  );
  insertRecordsFromTSV (store, &TEST_TB_T15, "/tmp/griddb_enhance_t15.data");
  
  table_info TEST_TB_GRIDDB_MAX_RANGE;
  set_tableInfo(store, "griddb_max_range", &TEST_TB_GRIDDB_MAX_RANGE,
                  16,
                  "c1", GS_TYPE_INTEGER, GS_TYPE_OPTION_NOT_NULL,
                  "c2", GS_TYPE_BYTE, GS_TYPE_OPTION_NULLABLE,
                  "c3", GS_TYPE_SHORT, GS_TYPE_OPTION_NULLABLE,
                  "c4", GS_TYPE_BOOL, GS_TYPE_OPTION_NULLABLE,
                  "c5", GS_TYPE_LONG, GS_TYPE_OPTION_NULLABLE,
                  "c6", GS_TYPE_FLOAT, GS_TYPE_OPTION_NULLABLE,
                  "c7", GS_TYPE_DOUBLE, GS_TYPE_OPTION_NULLABLE,
                  "c8", GS_TYPE_TIMESTAMP, GS_TYPE_OPTION_NULLABLE,
                  "c9", GS_TYPE_BOOL_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c10", GS_TYPE_BYTE_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c11", GS_TYPE_SHORT_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c12", GS_TYPE_INTEGER_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c13", GS_TYPE_LONG_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c14", GS_TYPE_FLOAT_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c15", GS_TYPE_DOUBLE_ARRAY, GS_TYPE_OPTION_NULLABLE,
                  "c16", GS_TYPE_TIMESTAMP_ARRAY, GS_TYPE_OPTION_NULLABLE
                  );
  insertRecordsFromTSV (store, &TEST_TB_GRIDDB_MAX_RANGE, "/tmp/griddb_enhance_griddb_max_range.data");
...
{
  if(argc != 6) {
    printf("Wrong syntax!!!\nExpected: ./griddb_init $HOST $PORT $CLUSTER $USER $PASSWORDS\n");
    return;
  }
