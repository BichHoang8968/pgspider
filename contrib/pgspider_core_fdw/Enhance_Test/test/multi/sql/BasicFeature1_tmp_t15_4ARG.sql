...
-- Testcase 91:
SELECT sum(c3), sum(c4) FROM tmp_t15 GROUP BY c2 ORDER BY 1  ASC, 2;
-- Testcase 92:
SELECT sum(c3), sum(c4) FROM tmp_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2;
-- Testcase 93:
SELECT sum(c3), sum(c4) FROM tmp_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2;
-- Testcase 94:
SELECT sum(c3), sum(c4) FROM tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2;
-- Testcase 95:
SELECT sum(c3), sum(c4) FROM tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2;
-- Testcase 96:
SELECT sum(c3), sum(c4) FROM tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2;
-- Testcase 97:
SELECT sum(c3), sum(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 ORDER BY 1  ASC, 2;
-- Testcase 98:
SELECT sum(c3), sum(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2;
-- Testcase 99:
SELECT sum(c3), sum(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2;
-- Testcase 100:
SELECT sum(c3), sum(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2;
-- Testcase 101:
SELECT sum(c3), sum(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2;
-- Testcase 102:
SELECT sum(c3), sum(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2;
-- Testcase 103:
SELECT sum(c3), sum(c4) FROM view_t15 GROUP BY c2 ORDER BY 1  ASC, 2;
-- Testcase 104:
SELECT sum(c3), sum(c4) FROM view_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2;
-- Testcase 105:
SELECT sum(c3), sum(c4) FROM view_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2;
-- Testcase 106:
SELECT sum(c3), sum(c4) FROM view_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2;
-- Testcase 107:
SELECT sum(c3), sum(c4) FROM view_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2;
-- Testcase 108:
SELECT sum(c3), sum(c4) FROM view_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2;
-- Testcase 109:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM tmp_t15 GROUP BY c2 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 110:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM tmp_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 111:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM tmp_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 112:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 113:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 114:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 115:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 116:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 117:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 118:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 119:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 120:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 121:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM view_t15 GROUP BY c2 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 122:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM view_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 123:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM view_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 124:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM view_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 125:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM view_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 126:
SELECT sum(c3+c4), sum(2*c3+c4/2+10), sum(c4-c3)+2000 FROM view_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 127:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM tmp_t15 GROUP BY c2 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 128:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM tmp_t15 GROUP BY time, c2, c3 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 129:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM tmp_t15 GROUP BY c2, __spd_url ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 130:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 131:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 132:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 133:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 134:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY time, c2, c3 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 135:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2, __spd_url ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 136:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 137:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 138:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 139:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM view_t15 GROUP BY c2 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 140:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM view_t15 GROUP BY time, c2, c3 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 141:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM view_t15 GROUP BY c2, __spd_url ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 142:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM view_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 143:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM view_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 144:
SELECT avg(c3), avg(c4), avg(c3+c4), avg(c3/5+c4*20+10), avg(c4-c3)+2000 FROM view_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY  1 DESC, 2 ASC, 3 ASC, 4, 5;
-- Testcase 145:
...
-- Testcase 163:
SELECT stddev(c3), stddev(c4) FROM tmp_t15 GROUP BY c2 ORDER BY 1  ASC, 2;
-- Testcase 164:
SELECT stddev(c3), stddev(c4) FROM tmp_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2;
-- Testcase 165:
SELECT stddev(c3), stddev(c4) FROM tmp_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2;
-- Testcase 166:
SELECT stddev(c3), stddev(c4) FROM tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2;
-- Testcase 167:
SELECT stddev(c3), stddev(c4) FROM tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2;
-- Testcase 168:
SELECT stddev(c3), stddev(c4) FROM tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2;
-- Testcase 169:
SELECT stddev(c3), stddev(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 ORDER BY 1  ASC, 2;
-- Testcase 170:
SELECT stddev(c3), stddev(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2;
-- Testcase 171:
SELECT stddev(c3), stddev(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2;
-- Testcase 172:
SELECT stddev(c3), stddev(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2;
-- Testcase 173:
SELECT stddev(c3), stddev(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2;
-- Testcase 174:
SELECT stddev(c3), stddev(c4) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2;
-- Testcase 175:
SELECT stddev(c3), stddev(c4) FROM view_t15 GROUP BY c2 ORDER BY 1  ASC, 2;
-- Testcase 176:
SELECT stddev(c3), stddev(c4) FROM view_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2;
-- Testcase 177:
SELECT stddev(c3), stddev(c4) FROM view_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2;
-- Testcase 178:
SELECT stddev(c3), stddev(c4) FROM view_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2;
-- Testcase 179:
SELECT stddev(c3), stddev(c4) FROM view_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2;
-- Testcase 180:
SELECT stddev(c3), stddev(c4) FROM view_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2;
-- Testcase 181:
...
-- Testcase 343:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM tmp_t15 GROUP BY c2 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 344:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM tmp_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 345:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM tmp_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 346:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 347:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 348:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 349:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 350:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 351:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 352:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 353:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 354:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM (SELECT * FROM tmp_t15 WHERE c3>c4 OR c4 != 7654) AS tmp_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 355:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM view_t15 GROUP BY c2 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 356:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM view_t15 GROUP BY time, c2, c3 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 357:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM view_t15 GROUP BY c2, __spd_url ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 358:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM view_t15 GROUP BY c2 HAVING c2 LIKE 'The%' OR c2 LIKE 'いろ%' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 359:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM view_t15 GROUP BY c3, c4 HAVING max(c3)<max(c4) AND sum(c4)<100000 ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 360:
SELECT sum(c3) filter (WHERE c3>0), count(*) filter (WHERE c3<c4), max(c4) filter (WHERE c4/50<0) FROM view_t15 GROUP BY c4, __spd_url HAVING avg(c4)>-1000 AND __spd_url != '/influx1/' ORDER BY 1  ASC, 2 DESC, 3 DESC;
-- Testcase 361:
