...
-- Testcase 136:
SELECT avg(c28) FROM t9 GROUP BY c13 ORDER BY 1;
-- Testcase 137:
SELECT avg(c28) FROM t9 GROUP BY c2, c13 ORDER BY 1;
-- Testcase 138:
SELECT avg(c28) FROM t9 GROUP BY c13, c5, __spd_url ORDER BY 1;
-- Testcase 139:
SELECT avg(c28) FROM t9 GROUP BY c1 HAVING min(c1)<>1 AND avg(c1) != 0 AND c1>-1000 ORDER BY 1;
-- Testcase 140:
SELECT avg(c28) FROM t9 GROUP BY c2, c9 HAVING count(c2) != 10 AND c9 != '1234ABCDEK' ORDER BY 1;
-- Testcase 141:
SELECT avg(c28) FROM t9 GROUP BY c3, c5, c13, __spd_url HAVING c3 != b'1111111111' AND c5=true and __spd_url != '/abcd/' ORDER BY 1;
-- Testcase 142:
SELECT avg(c28) FROM ( SELECT * FROM t9 WHERE c29>=0 ) AS tb9 GROUP BY c13 ORDER BY 1;
-- Testcase 143:
SELECT avg(c28) FROM ( SELECT * FROM t9 WHERE c29>=0 ) AS tb9 GROUP BY c2, c13 ORDER BY 1;
-- Testcase 144:
SELECT avg(c28) FROM ( SELECT * FROM t9 WHERE c29>=0 ) AS tb9 GROUP BY c13, c5, __spd_url ORDER BY 1;
-- Testcase 145:
SELECT avg(c28) FROM ( SELECT * FROM t9 WHERE c29>=0 ) AS tb9 GROUP BY c1 HAVING min(c1)<>1 AND avg(c1) != 0 AND c1>-1000 ORDER BY 1;
-- Testcase 146:
SELECT avg(c28) FROM ( SELECT * FROM t9 WHERE c29>=0 ) AS tb9 GROUP BY c2, c9 HAVING count(c2) != 10 AND c9 != '1234ABCDEK' ORDER BY 1;
-- Testcase 147:
SELECT avg(c28) FROM ( SELECT * FROM t9 WHERE c29>=0 ) AS tb9 GROUP BY c3, c5, c13, __spd_url HAVING c3 != b'1111111111' AND c5=true and __spd_url != '/abcd/' ORDER BY 1;
-- Testcase 148:
SELECT avg(c28) FROM view_t9 GROUP BY c13 ORDER BY 1;
-- Testcase 149:
SELECT avg(c28) FROM view_t9 GROUP BY c2, c13 ORDER BY 1;
-- Testcase 150:
SELECT avg(c28) FROM view_t9 GROUP BY c13, c5, __spd_url ORDER BY 1;
-- Testcase 151:
SELECT avg(c28) FROM view_t9 GROUP BY c1 HAVING min(c1)<>1 AND avg(c1) != 0 AND c1>-1000 ORDER BY 1;
-- Testcase 152:
SELECT avg(c28) FROM view_t9 GROUP BY c2, c9 HAVING count(c2) != 10 AND c9 != '1234ABCDEK' ORDER BY 1;
-- Testcase 153:
SELECT avg(c28) FROM view_t9 GROUP BY c3, c5, c13, __spd_url HAVING c3 != b'1111111111' AND c5=true and __spd_url != '/abcd/' ORDER BY 1;
-- Testcase 154:
