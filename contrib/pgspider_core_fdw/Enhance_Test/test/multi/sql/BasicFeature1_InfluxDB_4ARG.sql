...
-- Testcase 85:
SELECT sum(c3), sum(c4) FROM t7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 86:
SELECT sum(c3), sum(c4) FROM t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 87:
SELECT sum(c3), sum(c4) FROM t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 88:
SELECT sum(c3), sum(c4) FROM t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 89:
SELECT sum(c3), sum(c4) FROM t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 90:
SELECT sum(c3), sum(c4) FROM t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 91:
SELECT sum(c3), sum(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 92:
SELECT sum(c3), sum(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 93:
SELECT sum(c3), sum(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 94:
SELECT sum(c3), sum(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 95:
SELECT sum(c3), sum(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 96:
SELECT sum(c3), sum(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 97:
SELECT sum(c3), sum(c4) FROM view_t7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 98:
SELECT sum(c3), sum(c4) FROM view_t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 99:
SELECT sum(c3), sum(c4) FROM view_t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 100:
SELECT sum(c3), sum(c4) FROM view_t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 101:
SELECT sum(c3), sum(c4) FROM view_t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 102:
SELECT sum(c3), sum(c4) FROM view_t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 103:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM t7 GROUP BY time ORDER BY 1 DESC, 2, 3;
-- Testcase 104:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM t7 GROUP BY c2 ORDER BY 1 DESC, 2, 3;
-- Testcase 105:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 DESC, 2, 3;
-- Testcase 106:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 DESC, 2, 3;
-- Testcase 107:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 DESC, 2, 3;
-- Testcase 108:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 DESC, 2, 3;
-- Testcase 109:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY time ORDER BY 1 DESC, 2, 3;
-- Testcase 110:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2 ORDER BY 1 DESC, 2, 3;
-- Testcase 111:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 DESC, 2, 3;
-- Testcase 112:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 DESC, 2, 3;
-- Testcase 113:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 DESC, 2, 3;
-- Testcase 114:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c5 HAVING c5 != true ORDER BY 1 DESC, 2, 3;
-- Testcase 115:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM view_t7 GROUP BY time ORDER BY 1 DESC, 2, 3;
-- Testcase 116:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM view_t7 GROUP BY c2 ORDER BY 1 DESC, 2, 3;
-- Testcase 117:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM view_t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 DESC, 2, 3;
-- Testcase 118:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM view_t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 DESC, 2, 3;
-- Testcase 119:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM view_t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 DESC, 2, 3;
-- Testcase 120:
SELECT sum(c3+c4), sum(c3*2), sum(c3)-5 FROM view_t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 DESC, 2, 3;
-- Testcase 121:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM t7 GROUP BY time ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 122:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 123:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 124:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 125:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 126:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 127:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY time ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 128:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2 ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 129:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 130:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 131:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 132:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 133:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM view_t7 GROUP BY time ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 134:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM view_t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 135:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM view_t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 136:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM view_t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 137:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM view_t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 138:
SELECT avg(c4), avg(c3), avg(c3)-10, avg(c3)*0.5 FROM view_t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC,3 ASC,4;
-- Testcase 139:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM t7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 140:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 141:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 142:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 143:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 144:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 145:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 146:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 147:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 148:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 149:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 150:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 151:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM view_t7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 152:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM view_t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 153:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM view_t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 154:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM view_t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 155:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM view_t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 156:
SELECT avg(c4-c3) c1, avg(c3)>50 FROM view_t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 157:
...
-- Testcase 175:
SELECT stddev(c3), stddev(c4) FROM t7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 176:
SELECT stddev(c3), stddev(c4) FROM t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 177:
SELECT stddev(c3), stddev(c4) FROM t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 178:
SELECT stddev(c3), stddev(c4) FROM t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 179:
SELECT stddev(c3), stddev(c4) FROM t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 180:
SELECT stddev(c3), stddev(c4) FROM t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 181:
SELECT stddev(c3), stddev(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 182:
SELECT stddev(c3), stddev(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 183:
SELECT stddev(c3), stddev(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 184:
SELECT stddev(c3), stddev(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 185:
SELECT stddev(c3), stddev(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 186:
SELECT stddev(c3), stddev(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 187:
SELECT stddev(c3), stddev(c4) FROM view_t7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 188:
SELECT stddev(c3), stddev(c4) FROM view_t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 189:
SELECT stddev(c3), stddev(c4) FROM view_t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 190:
SELECT stddev(c3), stddev(c4) FROM view_t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 191:
SELECT stddev(c3), stddev(c4) FROM view_t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 192:
SELECT stddev(c3), stddev(c4) FROM view_t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 193:
...
-- Testcase 325:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM t7 GROUP BY time ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 326:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM t7 GROUP BY c2 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 327:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 328:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 329:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 330:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 331:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY time ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 332:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 333:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 334:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 335:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 336:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c5 HAVING c5 != true ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 337:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM view_t7 GROUP BY time ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 338:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM view_t7 GROUP BY c2 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 339:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM view_t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 340:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM view_t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 341:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM view_t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 342:
SELECT max(time), min(c3), sum(c4), count(*), avg(c4) FROM view_t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 343:
SELECT time, max(c3), min(c4-c3), sum(c3), count(c2), avg(c4) FROM t7 GROUP BY time ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 344:
SELECT time, max(c3), min(c4-c3), sum(c3), count(c2), avg(c4) FROM t7 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 345:
SELECT time, max(c3), min(c4-c3), sum(c3), count(c2), avg(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY time ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 346:
SELECT time, max(c3), min(c4-c3), sum(c3), count(c2), avg(c4) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 347:
SELECT time, max(c3), min(c4-c3), sum(c3), count(c2), avg(c4) FROM view_t7 GROUP BY time ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 348:
SELECT time, max(c3), min(c4-c3), sum(c3), count(c2), avg(c4) FROM view_t7 ORDER BY 1 DESC,2 ASC,3 DESC,4,5;
-- Testcase 349:
...
-- Testcase 379:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM t7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 380:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 381:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 382:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 383:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 384:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 385:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 386:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 387:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 388:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 389:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 390:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM ( SELECT * FROM t7 WHERE c3>-1000 AND c4<1000 ) AS tb7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 391:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM view_t7 GROUP BY time ORDER BY 1 ASC,2 DESC;
-- Testcase 392:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM view_t7 GROUP BY c2 ORDER BY 1 ASC,2 DESC;
-- Testcase 393:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM view_t7 GROUP BY c3, c4 HAVING min(c3)>min(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 394:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM view_t7 GROUP BY c2, c3, c4 HAVING sum(c3)>avg(c4) ORDER BY 1 ASC,2 DESC;
-- Testcase 395:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM view_t7 GROUP BY c3, c4 HAVING min(c3)<100 AND max(c4)<1000 AND sum(c3)>-1000 AND avg(c3)>-1000 ORDER BY 1 ASC,2 DESC;
-- Testcase 396:
SELECT sum(c3) filter (WHERE c3<100 and c3>-100), avg(c4) filter (WHERE c4 >0 AND c4<100) FROM view_t7 GROUP BY c5 HAVING c5 != true ORDER BY 1 ASC,2 DESC;
-- Testcase 397:
