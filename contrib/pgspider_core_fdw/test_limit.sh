...
cd ../../
sed -i 's/REGRESS =.*/REGRESS = limit\/model1 limit\/model2 limit\/model3 limit\/model4 limit\/model5 limit\/model6 limit\/model7 limit\/join_limit_postgres_fdw limit\/join_limit_mysql_fdw limit\/join_limit_influxdb_fdw limit\/join_limit_file_fdw limit\/join_limit_multi_node/' Makefile
