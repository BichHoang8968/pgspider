...
cd $DATA_PATH
rm /tmp/test_setcluster/* /tmp/test_setcluster2/* /tmp/test_setcluster3/*
mkdir -p /tmp/test_setcluster /tmp/test_setcluster2 /tmp/test_setcluster3
cp ./tbl_file.csv ./tbl_file2.csv /tmp/test_setcluster/
cp ./tbl_file3.csv /tmp/test_setcluster2/
cp ./tbl_file4.csv /tmp/test_setcluster3/
