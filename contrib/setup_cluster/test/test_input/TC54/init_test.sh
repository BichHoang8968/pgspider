...
$PGS1_DIR/bin/psql -p $PGS1_PORT pgspider -c "create user pgspider with encrypted password 'pgspider';"
...
$PGS1_DIR/bin/psql -p $PGS1_PORT pgspider -c "CREATE ROLE pgspider2 LOGIN SUPERUSER encrypted PASSWORD 'pgspider2';"
