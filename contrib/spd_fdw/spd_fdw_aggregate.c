 ...
 */
void
spd_get_agg_Info_push(TupleTableSlot *aggSlot, const ForeignScanState *node, int count, ForeignAggInfo * agginfodata)
{
	int			natts;
	int			natts_real = 0;
	bool		isnull = false;
...
TupleTableSlot *
spd_get_agg_tuple(ForeignAggInfo * agginfodata, TupleTableSlot *dest)
{
	HeapTuple	tuple;
	Datum	   *values;
	bool	   *nulls;
