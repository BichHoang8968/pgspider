...
CREATE FOREIGN TABLE minstring (i text) SERVER pgspider1;
CREATE FOREIGN TABLE minstring__pgspider2__0 (i text) SERVER pgspider2 OPTIONS (table_name 'mintext');
CREATE FOREIGN TABLE minstring__postgresql1__0 (i text) SERVER postgresql1 OPTIONS (table_name 'mintext');
CREATE FOREIGN TABLE minstring__sqlite__0 (i text) SERVER sqlite OPTIONS (table 'mintext');
