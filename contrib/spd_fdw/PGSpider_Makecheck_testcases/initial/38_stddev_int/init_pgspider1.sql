...
CREATE FOREIGN TABLE stddevint (i int) SERVER pgspider1;
CREATE FOREIGN TABLE stddevint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'stddevint');
CREATE FOREIGN TABLE stddevint__postgresql1__0 (i int) SERVER postgresql1 OPTIONS (table_name 'stddevint');
CREATE FOREIGN TABLE stddevint__sqlite__0 (i int) SERVER sqlite OPTIONS (table 'stddevint');
