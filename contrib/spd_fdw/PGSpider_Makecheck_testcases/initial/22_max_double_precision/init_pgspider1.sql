...
CREATE FOREIGN TABLE maxdouble (i double precision) SERVER pgspider1;
CREATE FOREIGN TABLE maxdouble__postgresql1__0 (i double precision) SERVER postgresql1 OPTIONS (table_name 'maxdouble');
CREATE FOREIGN TABLE maxdouble__pgspider2__0 (i double precision) SERVER pgspider2 OPTIONS (table_name 'maxdouble');
CREATE FOREIGN TABLE maxdouble__sqlite__0 (i double precision) SERVER sqlite OPTIONS (table 'maxdouble');
