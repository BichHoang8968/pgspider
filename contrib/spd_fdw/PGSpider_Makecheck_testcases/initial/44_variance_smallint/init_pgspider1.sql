...
CREATE FOREIGN TABLE variancesmallint (i smallint) SERVER pgspider1;
CREATE FOREIGN TABLE variancesmallint__pgspider2__0 (i smallint) SERVER pgspider2 OPTIONS (table_name 'variancesmallint');
CREATE FOREIGN TABLE variancesmallint__postgresql1__0 (i smallint) SERVER postgresql1 OPTIONS (table_name 'variancesmallint');
CREATE FOREIGN TABLE variancesmallint__sqlite__0 (i smallint) SERVER sqlite OPTIONS (table 'variancesmallint');
