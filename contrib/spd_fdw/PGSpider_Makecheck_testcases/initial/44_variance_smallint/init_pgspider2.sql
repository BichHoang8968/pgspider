...
CREATE FOREIGN TABLE variancesmallint (i smallint) SERVER pgspider2;
CREATE FOREIGN TABLE variancesmallint__postgresql2__0 (i smallint) SERVER postgresql2 OPTIONS (table_name 'variancesmallint');
CREATE FOREIGN TABLE variancesmallint__csv__0 (i smallint) SERVER csv OPTIONS (filename '/tmp/variancesmallint.csv', format 'csv');
