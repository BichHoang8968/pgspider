...
CREATE FOREIGN TABLE variancedouble (i double precision) SERVER pgspider1;
CREATE FOREIGN TABLE variancedouble__pgspider2__0 (i double precision) SERVER pgspider2 OPTIONS (table_name 'variancedouble');
CREATE FOREIGN TABLE variancedouble__postgresql1__0 (i double precision) SERVER postgresql1 OPTIONS (table_name 'variancedouble');
CREATE FOREIGN TABLE variancedouble__sqlite__0 (i double precision) SERVER sqlite OPTIONS (table 'variancedouble');
