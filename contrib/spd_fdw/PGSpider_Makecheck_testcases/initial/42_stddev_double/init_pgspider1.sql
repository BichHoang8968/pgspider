...
CREATE FOREIGN TABLE stddevdouble (i double precision) SERVER pgspider1;
CREATE FOREIGN TABLE stddevdouble__pgspider2__0 (i double precision) SERVER pgspider2 OPTIONS (table_name 'stddevdouble');
CREATE FOREIGN TABLE stddevdouble__postgresql1__0 (i double precision) SERVER postgresql1 OPTIONS (table_name 'stddevdouble');
CREATE FOREIGN TABLE stddevdouble__sqlite__0 (i double precision) SERVER sqlite OPTIONS (table 'stddevdouble');
