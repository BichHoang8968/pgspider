...
CREATE FOREIGN TABLE bitorbigint (i bigint) SERVER pgspider2;
CREATE FOREIGN TABLE bitorbigint__postgresql2__0 (i bigint) SERVER postgresql2 OPTIONS (table_name 'bitorbigint');
CREATE FOREIGN TABLE bitorbigint__csv__0 (i bigint) SERVER csv OPTIONS (filename '/tmp/bitorbigint.csv', format 'csv');
