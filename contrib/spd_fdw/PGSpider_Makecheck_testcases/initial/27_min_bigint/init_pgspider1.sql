...
CREATE FOREIGN TABLE minbigint (i bigint) SERVER pgspider1;
CREATE FOREIGN TABLE minbigint__pgspider2__0 (i bigint) SERVER pgspider2 OPTIONS (table_name 'minbigint');
CREATE FOREIGN TABLE minbigint__postgresql1__0 (i bigint) SERVER postgresql1 OPTIONS (table_name 'minbigint');
CREATE FOREIGN TABLE minbigint__sqlite__0 (i bigint) SERVER sqlite OPTIONS (table 'minbigint');
