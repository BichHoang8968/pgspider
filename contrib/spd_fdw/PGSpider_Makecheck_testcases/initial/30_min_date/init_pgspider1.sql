...
CREATE FOREIGN TABLE mindate (i date) SERVER pgspider1;
CREATE FOREIGN TABLE mindate__pgspider2__0 (i date) SERVER pgspider2 OPTIONS (table_name 'mindate');
CREATE FOREIGN TABLE mindate__postgresql1__0 (i date) SERVER postgresql1 OPTIONS (table_name 'mindate');
CREATE FOREIGN TABLE mindate__sqlite__0 (i date) SERVER sqlite OPTIONS (table 'mindate');
