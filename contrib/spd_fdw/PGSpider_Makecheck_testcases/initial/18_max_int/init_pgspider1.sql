...
CREATE FOREIGN TABLE maxint (i int) SERVER pgspider1;
CREATE FOREIGN TABLE maxint__postgresql1__0 (i int) SERVER postgresql1 OPTIONS (table_name 'maxint');
CREATE FOREIGN TABLE maxint__pgspider2__0 (i int) SERVER pgspider2 OPTIONS (table_name 'maxint');
CREATE FOREIGN TABLE maxint__sqlite__0 (i int) SERVER sqlite OPTIONS (table 'maxint');
