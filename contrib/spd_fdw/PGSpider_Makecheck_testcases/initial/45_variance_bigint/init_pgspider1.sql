...
CREATE FOREIGN TABLE variancebigint (i bigint) SERVER pgspider1;
CREATE FOREIGN TABLE variancebigint__pgspider2__0 (i bigint) SERVER pgspider2 OPTIONS (table_name 'variancebigint');
CREATE FOREIGN TABLE variancebigint__postgresql1__0 (i bigint) SERVER postgresql1 OPTIONS (table_name 'variancebigint');
CREATE FOREIGN TABLE variancebigint__sqlite__0 (i bigint) SERVER sqlite OPTIONS (table 'variancebigint');
