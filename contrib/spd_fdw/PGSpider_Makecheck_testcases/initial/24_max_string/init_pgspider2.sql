...
CREATE FOREIGN TABLE maxstring (i text) SERVER pgspider2;
CREATE FOREIGN TABLE maxstring__postgresql2__0(i text) SERVER postgresql2 OPTIONS (table_name 'maxstring');
CREATE FOREIGN TABLE maxstring__csv__0(i text) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/maxstring.csv');
