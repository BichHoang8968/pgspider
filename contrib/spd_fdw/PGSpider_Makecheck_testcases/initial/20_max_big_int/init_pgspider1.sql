...
CREATE FOREIGN TABLE maxbigint (i bigint) SERVER pgspider1;
CREATE FOREIGN TABLE maxbigint__postgresql1__0 (i bigint) SERVER postgresql1 OPTIONS (table_name 'maxbigint');
CREATE FOREIGN TABLE maxbigint__pgspider2__0 (i bigint) SERVER pgspider2 OPTIONS (table_name 'maxbigint');
CREATE FOREIGN TABLE maxbigint__sqlite__0 (i bigint) SERVER sqlite OPTIONS (table 'maxbigint');
