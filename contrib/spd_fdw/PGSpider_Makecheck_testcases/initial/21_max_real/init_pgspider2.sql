...
CREATE FOREIGN TABLE maxreal (i real) SERVER pgspider2;
CREATE FOREIGN TABLE maxreal__postgresql2__0(i real) SERVER postgresql2 OPTIONS (table_name 'maxreal');
CREATE FOREIGN TABLE maxreal__csv__0(i real) SERVER csv OPTIONS (filename '/home/test/PGSpider/Testing/File/maxreal.csv');
