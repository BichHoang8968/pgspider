...
CREATE FOREIGN TABLE maxreal (i real) SERVER pgspider1;
CREATE FOREIGN TABLE maxreal__postgresql1__0 (i real) SERVER postgresql1 OPTIONS (table_name 'maxreal');
CREATE FOREIGN TABLE maxreal__pgspider2__0 (i real) SERVER pgspider2 OPTIONS (table_name 'maxreal');
CREATE FOREIGN TABLE maxreal__sqlite__0 (i real) SERVER sqlite OPTIONS (table 'maxreal');
