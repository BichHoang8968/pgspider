...
CREATE FOREIGN TABLE minsmallint (i smallint) SERVER pgspider1;
CREATE FOREIGN TABLE minsmallint__pgspider2__0 (i smallint) SERVER pgspider2 OPTIONS (table_name 'minsmallint');
CREATE FOREIGN TABLE minsmallint__postgresql1__0 (i smallint) SERVER postgresql1 OPTIONS (table_name 'minsmallint');
CREATE FOREIGN TABLE minsmallint__sqlite__0 (i smallint) SERVER sqlite OPTIONS (table 'minsmallint');
