...
int pqexe_wrp(PGconn *conn,char *sql){
  PGresult *res;
...
int pqexe_wrp_nocheck(PGconn *conn,char *sql,char *option[]){
  PGresult *res;
  res = PQexec(conn ,&sql[0]);
  if (PQresultStatus(res) != PGRES_COMMAND_OK){
    /* reconnect if failed */
...
int create_connection(PGconn **conn,char *option[]){
  *conn = PQsetdbLogin(
           option[0],
           option[1],
           NULL,
...
int node_get(char *option[],PGconn *conn,int option_length){
  PGresult *resp;
  char sql[1024];
  int resp_cnt =0;
  int loop = 0;
...
int node_set_spd(char *option[],PGconn *conn,int option_length){
  char sql[1024];
  int rtn;
...
int node_set_tb(char *option[],PGconn *conn,int option_length){
  char sql[1024];
  int rtn;
...
int node_set_my(char *option[],PGconn *conn,int option_length){
  char sql[1024];
  int rtn = 0;
...
int node_set_pg(char *option[],PGconn *conn,int option_length){
  char sql[1024];
  int rtn = 0;
...
int node_set_sl(char *option[],PGconn *conn,int option_length){
  char sql[1024];
  int rtn = 0;
...
int node_set_file(char *option[],PGconn *conn,int option_length){
  char sql[1024];
  int rtn = 0;
...
int node_set_griddb(char *option[],PGconn *conn,int option_length){
  char sql[1024];
  int rtn;
...
int node_set(char *option[],PGconn *conn,int option_length){
...
int node_del(char *option[],PGconn *conn,int option_length){
  PGresult *res;
  char sql[1024];
  int resp_cnt =0;
  int loop = 0;
...
int table_get(char *option[],PGconn *conn, int option_length){
  PGresult *resp;
...
int table_set(char *option[],PGconn *conn, int option_length){
  char sql[1024];
  int rtn = 0;
  if(option_length != 6){
    ARG_INVALID("%s %d %s %d\n","Invalid args : args = ",option_length,"Expect = ",6);
...
int table_del(char *option[],PGconn *conn, int option_length){
  PGresult *resp;
  char sql[1024];
...
int get_mapping_nums(PGconn *conn,char *option[]){
   PGresult *res;
   char sql[1024];
   int resp_cnt =0;
   int loop = 0;
...
int mapping_set_spd(char *option[],PGconn *conn,int option_length,char *table_name){
  PGresult *res;
  char sql[1024];
  int resp_cnt =0;
  int rtn = 0;
...
int mapping_set_tb(char *option[],PGconn *conn,int option_length,char *table_name){
  char sql[1024];
  int resp_cnt =0;
  int rtn = 0;
...
int mapping_set_my(char *option[],PGconn *conn,int option_length,char *table_name){
  char sql[1024];
  int resp_cnt =0;
  int rtn = 0;
...
int mapping_set_pg(char *option[],PGconn *conn,int option_length,char *table_name){
  char sql[1024];
  int resp_cnt =0;
  int rtn = 0;
...
int mapping_set_sl(char *option[],PGconn *conn,int option_length,char *table_name){
  char sql[1024];
  int resp_cnt =0;
  int rtn = 0;
...
int mapping_set_file(char *option[],PGconn *conn,int option_length,char *table_name){
  char sql[1024];
  int resp_cnt =0;
  int rtn = 0;
...
int mapping_set_griddb(char *option[],PGconn *conn,int option_length,char *table_name){
  char sql[1024];
  int resp_cnt =0;
  int rtn = 0;
...
int check_column(char *option[],PGconn *conn,char *table_name){
  PGresult *res_par;
  PGresult *res_chi;
  char sql_par[1024];
  char sql_chi[1024];
...
int mapping_quick_drop(PGconn *conn, char *table_name){
  char sql[1024];
  int rtn = 0;
...
int mapping_set(char *option[],PGconn *conn, int option_length){
  PGresult *res;
  char sql[1024];
...
int mapping_del(char *option[],PGconn *conn, int option_length){
  PGresult *resp;
  char sql[1024];
  char temp_result[256][256];
  int resp_cnt =0;
