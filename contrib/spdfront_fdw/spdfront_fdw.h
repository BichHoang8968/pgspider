 ...
 *
 * IDENTIFICATION
 *		  contrib/postgres_fdw/spdfront_fdw.h
 *
 *-------------------------------------------------------------------------
 */
#ifndef SPDFRONT_FDW_H
#define SPDFRONT_FDW_H
 ...
 * spdfront_fdw foreign table.  For a baserel, this struct is created by
 * spdfrontGetForeignRelSize, although some fields are not filled till later.
 * spdfrontGetForeignJoinPaths creates it for a joinrel, and
 * spdfrontGetForeignUpperPaths creates it for an upperrel.
 */
